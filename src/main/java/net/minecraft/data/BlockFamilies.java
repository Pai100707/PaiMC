...
public class BlockFamilies {
   private static final Map<Block, net.minecraft.data.BlockFamily> MAP = Maps.newHashMap();
   ...
   public static final net.minecraft.data.BlockFamily ACACIA_PLANKS = familyBuilder(Blocks.ACACIA_PLANKS)
      ...
      .getFamily();
   public static final net.minecraft.data.BlockFamily CHERRY_PLANKS = familyBuilder(Blocks.CHERRY_PLANKS)
      ...
      .recipeUnlockedBy("has_planks")
      .getFamily();
   public static final net.minecraft.data.BlockFamily BIRCH_PLANKS = familyBuilder(Blocks.BIRCH_PLANKS)
      ...
      .recipeUnlockedBy("has_planks")
      .getFamily();
   public static final net.minecraft.data.BlockFamily CRIMSON_PLANKS = familyBuilder(Blocks.CRIMSON_PLANKS)
      ...
      .recipeUnlockedBy("has_planks")
      .getFamily();
   public static final net.minecraft.data.BlockFamily JUNGLE_PLANKS = familyBuilder(Blocks.JUNGLE_PLANKS)
      ...
      .recipeUnlockedBy("has_planks")
      .getFamily();
   public static final net.minecraft.data.BlockFamily OAK_PLANKS = familyBuilder(Blocks.OAK_PLANKS)
      ...
      .recipeUnlockedBy("has_planks")
      .getFamily();
   public static final net.minecraft.data.BlockFamily DARK_OAK_PLANKS = familyBuilder(Blocks.DARK_OAK_PLANKS)
      ...
      .recipeUnlockedBy("has_planks")
      .getFamily();
   public static final net.minecraft.data.BlockFamily PALE_OAK_PLANKS = familyBuilder(Blocks.PALE_OAK_PLANKS)
      ...
      .recipeUnlockedBy("has_planks")
      .getFamily();
   public static final net.minecraft.data.BlockFamily SPRUCE_PLANKS = familyBuilder(Blocks.SPRUCE_PLANKS)
      ...
      .recipeUnlockedBy("has_planks")
      .getFamily();
   public static final net.minecraft.data.BlockFamily WARPED_PLANKS = familyBuilder(Blocks.WARPED_PLANKS)
      ...
      .recipeUnlockedBy("has_planks")
      .getFamily();
   public static final net.minecraft.data.BlockFamily MANGROVE_PLANKS = familyBuilder(Blocks.MANGROVE_PLANKS)
      ...
      .recipeUnlockedBy("has_planks")
      .getFamily();
   public static final net.minecraft.data.BlockFamily BAMBOO_PLANKS = familyBuilder(Blocks.BAMBOO_PLANKS)
      ...
      .recipeUnlockedBy("has_planks")
      .getFamily();
   public static final net.minecraft.data.BlockFamily BAMBOO_MOSAIC = familyBuilder(Blocks.BAMBOO_MOSAIC)
      .slab(Blocks.BAMBOO_MOSAIC_SLAB)
      .stairs(Blocks.BAMBOO_MOSAIC_STAIRS)
      .getFamily();
   public static final net.minecraft.data.BlockFamily MUD_BRICKS = familyBuilder(Blocks.MUD_BRICKS)
      .wall(Blocks.MUD_BRICK_WALL)
      .stairs(Blocks.MUD_BRICK_STAIRS)
      .slab(Blocks.MUD_BRICK_SLAB)
      .getFamily();
   public static final net.minecraft.data.BlockFamily ANDESITE = familyBuilder(Blocks.ANDESITE)
      .wall(Blocks.ANDESITE_WALL)
      .stairs(Blocks.ANDESITE_STAIRS)
      .slab(Blocks.ANDESITE_SLAB)
      .polished(Blocks.POLISHED_ANDESITE)
      .getFamily();
   public static final net.minecraft.data.BlockFamily POLISHED_ANDESITE = familyBuilder(Blocks.POLISHED_ANDESITE)
      .stairs(Blocks.POLISHED_ANDESITE_STAIRS)
      .slab(Blocks.POLISHED_ANDESITE_SLAB)
      .getFamily();
   public static final net.minecraft.data.BlockFamily BLACKSTONE = familyBuilder(Blocks.BLACKSTONE)
      .wall(Blocks.BLACKSTONE_WALL)
      .stairs(Blocks.BLACKSTONE_STAIRS)
      .slab(Blocks.BLACKSTONE_SLAB)
      .polished(Blocks.POLISHED_BLACKSTONE)
      .getFamily();
   public static final net.minecraft.data.BlockFamily POLISHED_BLACKSTONE = familyBuilder(Blocks.POLISHED_BLACKSTONE)
      ...
      .getFamily();
   public static final net.minecraft.data.BlockFamily POLISHED_BLACKSTONE_BRICKS = familyBuilder(Blocks.POLISHED_BLACKSTONE_BRICKS)
      ...
      .getFamily();
   public static final net.minecraft.data.BlockFamily BRICKS = familyBuilder(Blocks.BRICKS)
      .wall(Blocks.BRICK_WALL)
      .stairs(Blocks.BRICK_STAIRS)
      .slab(Blocks.BRICK_SLAB)
      .getFamily();
   public static final net.minecraft.data.BlockFamily END_STONE_BRICKS = familyBuilder(Blocks.END_STONE_BRICKS)
      .wall(Blocks.END_STONE_BRICK_WALL)
      .stairs(Blocks.END_STONE_BRICK_STAIRS)
      .slab(Blocks.END_STONE_BRICK_SLAB)
      .getFamily();
   public static final net.minecraft.data.BlockFamily MOSSY_STONE_BRICKS = familyBuilder(Blocks.MOSSY_STONE_BRICKS)
      .wall(Blocks.MOSSY_STONE_BRICK_WALL)
      .stairs(Blocks.MOSSY_STONE_BRICK_STAIRS)
      .slab(Blocks.MOSSY_STONE_BRICK_SLAB)
      .getFamily();
   public static final net.minecraft.data.BlockFamily COPPER_BLOCK = familyBuilder(Blocks.COPPER_BLOCK).cut(Blocks.CUT_COPPER).dontGenerateModel().getFamily();
   public static final net.minecraft.data.BlockFamily CUT_COPPER = familyBuilder(Blocks.CUT_COPPER)
      .slab(Blocks.CUT_COPPER_SLAB)
      .stairs(Blocks.CUT_COPPER_STAIRS)
      .chiseled(Blocks.CHISELED_COPPER)
      .dontGenerateModel()
      .getFamily();
   public static final net.minecraft.data.BlockFamily WAXED_COPPER_BLOCK = familyBuilder(Blocks.WAXED_COPPER_BLOCK)
      .cut(Blocks.WAXED_CUT_COPPER)
      .recipeGroupPrefix("waxed_cut_copper")
      .dontGenerateModel()
      .getFamily();
   public static final net.minecraft.data.BlockFamily WAXED_CUT_COPPER = familyBuilder(Blocks.WAXED_CUT_COPPER)
      .slab(Blocks.WAXED_CUT_COPPER_SLAB)
      .stairs(Blocks.WAXED_CUT_COPPER_STAIRS)
      .recipeGroupPrefix("waxed_cut_copper")
      .dontGenerateModel()
      .getFamily();
   public static final net.minecraft.data.BlockFamily EXPOSED_COPPER = familyBuilder(Blocks.EXPOSED_COPPER)
      .cut(Blocks.EXPOSED_CUT_COPPER)
      .dontGenerateModel()
      .getFamily();
   public static final net.minecraft.data.BlockFamily EXPOSED_CUT_COPPER = familyBuilder(Blocks.EXPOSED_CUT_COPPER)
      .slab(Blocks.EXPOSED_CUT_COPPER_SLAB)
      .stairs(Blocks.EXPOSED_CUT_COPPER_STAIRS)
      .chiseled(Blocks.EXPOSED_CHISELED_COPPER)
      .dontGenerateModel()
      .getFamily();
   public static final net.minecraft.data.BlockFamily WAXED_EXPOSED_COPPER = familyBuilder(Blocks.WAXED_EXPOSED_COPPER)
      .cut(Blocks.WAXED_EXPOSED_CUT_COPPER)
      .recipeGroupPrefix("waxed_exposed_cut_copper")
      .dontGenerateModel()
      .getFamily();
   public static final net.minecraft.data.BlockFamily WAXED_EXPOSED_CUT_COPPER = familyBuilder(Blocks.WAXED_EXPOSED_CUT_COPPER)
      .slab(Blocks.WAXED_EXPOSED_CUT_COPPER_SLAB)
      .stairs(Blocks.WAXED_EXPOSED_CUT_COPPER_STAIRS)
      .recipeGroupPrefix("waxed_exposed_cut_copper")
      .dontGenerateModel()
      .getFamily();
   public static final net.minecraft.data.BlockFamily WEATHERED_COPPER = familyBuilder(Blocks.WEATHERED_COPPER)
      .cut(Blocks.WEATHERED_CUT_COPPER)
      .dontGenerateModel()
      .getFamily();
   public static final net.minecraft.data.BlockFamily WEATHERED_CUT_COPPER = familyBuilder(Blocks.WEATHERED_CUT_COPPER)
      .slab(Blocks.WEATHERED_CUT_COPPER_SLAB)
      .stairs(Blocks.WEATHERED_CUT_COPPER_STAIRS)
      .chiseled(Blocks.WEATHERED_CHISELED_COPPER)
      .dontGenerateModel()
      .getFamily();
   public static final net.minecraft.data.BlockFamily WAXED_WEATHERED_COPPER = familyBuilder(Blocks.WAXED_WEATHERED_COPPER)
      .cut(Blocks.WAXED_WEATHERED_CUT_COPPER)
      .recipeGroupPrefix("waxed_weathered_cut_copper")
      .dontGenerateModel()
      .getFamily();
   public static final net.minecraft.data.BlockFamily WAXED_WEATHERED_CUT_COPPER = familyBuilder(Blocks.WAXED_WEATHERED_CUT_COPPER)
      .slab(Blocks.WAXED_WEATHERED_CUT_COPPER_SLAB)
      .stairs(Blocks.WAXED_WEATHERED_CUT_COPPER_STAIRS)
      .recipeGroupPrefix("waxed_weathered_cut_copper")
      .dontGenerateModel()
      .getFamily();
   public static final net.minecraft.data.BlockFamily OXIDIZED_COPPER = familyBuilder(Blocks.OXIDIZED_COPPER)
      .cut(Blocks.OXIDIZED_CUT_COPPER)
      .dontGenerateModel()
      .getFamily();
   public static final net.minecraft.data.BlockFamily OXIDIZED_CUT_COPPER = familyBuilder(Blocks.OXIDIZED_CUT_COPPER)
      .slab(Blocks.OXIDIZED_CUT_COPPER_SLAB)
      .stairs(Blocks.OXIDIZED_CUT_COPPER_STAIRS)
      .chiseled(Blocks.OXIDIZED_CHISELED_COPPER)
      .dontGenerateModel()
      .getFamily();
   public static final net.minecraft.data.BlockFamily WAXED_OXIDIZED_COPPER = familyBuilder(Blocks.WAXED_OXIDIZED_COPPER)
      .cut(Blocks.WAXED_OXIDIZED_CUT_COPPER)
      .recipeGroupPrefix("waxed_oxidized_cut_copper")
      .dontGenerateModel()
      .getFamily();
   public static final net.minecraft.data.BlockFamily WAXED_OXIDIZED_CUT_COPPER = familyBuilder(Blocks.WAXED_OXIDIZED_CUT_COPPER)
      .slab(Blocks.WAXED_OXIDIZED_CUT_COPPER_SLAB)
      .stairs(Blocks.WAXED_OXIDIZED_CUT_COPPER_STAIRS)
      .recipeGroupPrefix("waxed_oxidized_cut_copper")
      .dontGenerateModel()
      .getFamily();
   public static final net.minecraft.data.BlockFamily COBBLESTONE = familyBuilder(Blocks.COBBLESTONE)
      .wall(Blocks.COBBLESTONE_WALL)
      .stairs(Blocks.COBBLESTONE_STAIRS)
      .slab(Blocks.COBBLESTONE_SLAB)
      .getFamily();
   public static final net.minecraft.data.BlockFamily MOSSY_COBBLESTONE = familyBuilder(Blocks.MOSSY_COBBLESTONE)
      .wall(Blocks.MOSSY_COBBLESTONE_WALL)
      .stairs(Blocks.MOSSY_COBBLESTONE_STAIRS)
      .slab(Blocks.MOSSY_COBBLESTONE_SLAB)
      .getFamily();
   public static final net.minecraft.data.BlockFamily DIORITE = familyBuilder(Blocks.DIORITE)
      .wall(Blocks.DIORITE_WALL)
      .stairs(Blocks.DIORITE_STAIRS)
      .slab(Blocks.DIORITE_SLAB)
      .polished(Blocks.POLISHED_DIORITE)
      .getFamily();
   public static final net.minecraft.data.BlockFamily POLISHED_DIORITE = familyBuilder(Blocks.POLISHED_DIORITE)
      .stairs(Blocks.POLISHED_DIORITE_STAIRS)
      .slab(Blocks.POLISHED_DIORITE_SLAB)
      .getFamily();
   public static final net.minecraft.data.BlockFamily GRANITE = familyBuilder(Blocks.GRANITE)
      .wall(Blocks.GRANITE_WALL)
      .stairs(Blocks.GRANITE_STAIRS)
      .slab(Blocks.GRANITE_SLAB)
      .polished(Blocks.POLISHED_GRANITE)
      .getFamily();
   public static final net.minecraft.data.BlockFamily POLISHED_GRANITE = familyBuilder(Blocks.POLISHED_GRANITE)
      .stairs(Blocks.POLISHED_GRANITE_STAIRS)
      .slab(Blocks.POLISHED_GRANITE_SLAB)
      .getFamily();
   public static final net.minecraft.data.BlockFamily TUFF = familyBuilder(Blocks.TUFF)
      ...
      .getFamily();
   public static final net.minecraft.data.BlockFamily POLISHED_TUFF = familyBuilder(Blocks.POLISHED_TUFF)
      ...
      .getFamily();
   public static final net.minecraft.data.BlockFamily TUFF_BRICKS = familyBuilder(Blocks.TUFF_BRICKS)
      ...
      .getFamily();
   public static final net.minecraft.data.BlockFamily RESIN_BRICKS = familyBuilder(Blocks.RESIN_BRICKS)
      ...
      .getFamily();
   public static final net.minecraft.data.BlockFamily NETHER_BRICKS = familyBuilder(Blocks.NETHER_BRICKS)
      ...
      .getFamily();
   public static final net.minecraft.data.BlockFamily RED_NETHER_BRICKS = familyBuilder(Blocks.RED_NETHER_BRICKS)
      .slab(Blocks.RED_NETHER_BRICK_SLAB)
      .stairs(Blocks.RED_NETHER_BRICK_STAIRS)
      .wall(Blocks.RED_NETHER_BRICK_WALL)
      .getFamily();
   public static final net.minecraft.data.BlockFamily PRISMARINE = familyBuilder(Blocks.PRISMARINE)
      .wall(Blocks.PRISMARINE_WALL)
      .stairs(Blocks.PRISMARINE_STAIRS)
      .slab(Blocks.PRISMARINE_SLAB)
      .getFamily();
   public static final net.minecraft.data.BlockFamily PURPUR = familyBuilder(Blocks.PURPUR_BLOCK)
      .stairs(Blocks.PURPUR_STAIRS)
      .slab(Blocks.PURPUR_SLAB)
      .dontGenerateRecipe()
      .getFamily();
   public static final net.minecraft.data.BlockFamily PRISMARINE_BRICKS = familyBuilder(Blocks.PRISMARINE_BRICKS)
      .stairs(Blocks.PRISMARINE_BRICK_STAIRS)
      .slab(Blocks.PRISMARINE_BRICK_SLAB)
      .getFamily();
   public static final net.minecraft.data.BlockFamily DARK_PRISMARINE = familyBuilder(Blocks.DARK_PRISMARINE)
      .stairs(Blocks.DARK_PRISMARINE_STAIRS)
      .slab(Blocks.DARK_PRISMARINE_SLAB)
      .getFamily();
   public static final net.minecraft.data.BlockFamily QUARTZ = familyBuilder(Blocks.QUARTZ_BLOCK)
      .stairs(Blocks.QUARTZ_STAIRS)
      .slab(Blocks.QUARTZ_SLAB)
      .chiseled(Blocks.CHISELED_QUARTZ_BLOCK)
      .dontGenerateRecipe()
      .getFamily();
   public static final net.minecraft.data.BlockFamily SMOOTH_QUARTZ = familyBuilder(Blocks.SMOOTH_QUARTZ)
      .stairs(Blocks.SMOOTH_QUARTZ_STAIRS)
      .slab(Blocks.SMOOTH_QUARTZ_SLAB)
      .getFamily();
   public static final net.minecraft.data.BlockFamily SANDSTONE = familyBuilder(Blocks.SANDSTONE)
      ...
      .dontGenerateRecipe()
      .getFamily();
   public static final net.minecraft.data.BlockFamily CUT_SANDSTONE = familyBuilder(Blocks.CUT_SANDSTONE).slab(Blocks.CUT_SANDSTONE_SLAB).getFamily();
   public static final net.minecraft.data.BlockFamily SMOOTH_SANDSTONE = familyBuilder(Blocks.SMOOTH_SANDSTONE)
      .slab(Blocks.SMOOTH_SANDSTONE_SLAB)
      .stairs(Blocks.SMOOTH_SANDSTONE_STAIRS)
      .getFamily();
   public static final net.minecraft.data.BlockFamily RED_SANDSTONE = familyBuilder(Blocks.RED_SANDSTONE)
      ...
      .dontGenerateRecipe()
      .getFamily();
   public static final net.minecraft.data.BlockFamily CUT_RED_SANDSTONE = familyBuilder(Blocks.CUT_RED_SANDSTONE)
      .slab(Blocks.CUT_RED_SANDSTONE_SLAB)
      .getFamily();
   public static final net.minecraft.data.BlockFamily SMOOTH_RED_SANDSTONE = familyBuilder(Blocks.SMOOTH_RED_SANDSTONE)
      .slab(Blocks.SMOOTH_RED_SANDSTONE_SLAB)
      .stairs(Blocks.SMOOTH_RED_SANDSTONE_STAIRS)
      .getFamily();
   public static final net.minecraft.data.BlockFamily STONE = familyBuilder(Blocks.STONE)
      .slab(Blocks.STONE_SLAB)
      .pressurePlate(Blocks.STONE_PRESSURE_PLATE)
      .button(Blocks.STONE_BUTTON)
      .stairs(Blocks.STONE_STAIRS)
      .getFamily();
   public static final net.minecraft.data.BlockFamily STONE_BRICK = familyBuilder(Blocks.STONE_BRICKS)
      ...
      .dontGenerateRecipe()
      .getFamily();
   public static final net.minecraft.data.BlockFamily DEEPSLATE = familyBuilder(Blocks.DEEPSLATE).getFamily();
   public static final net.minecraft.data.BlockFamily COBBLED_DEEPSLATE = familyBuilder(Blocks.COBBLED_DEEPSLATE)
      ...
      .getFamily();
   public static final net.minecraft.data.BlockFamily POLISHED_DEEPSLATE = familyBuilder(Blocks.POLISHED_DEEPSLATE)
      .slab(Blocks.POLISHED_DEEPSLATE_SLAB)
      .stairs(Blocks.POLISHED_DEEPSLATE_STAIRS)
      .wall(Blocks.POLISHED_DEEPSLATE_WALL)
      .getFamily();
   public static final net.minecraft.data.BlockFamily DEEPSLATE_BRICKS = familyBuilder(Blocks.DEEPSLATE_BRICKS)
      ...
      .getFamily();
   public static final net.minecraft.data.BlockFamily DEEPSLATE_TILES = familyBuilder(Blocks.DEEPSLATE_TILES)
   ...
   private static net.minecraft.data.BlockFamily.Builder familyBuilder(Block $$0) {
      net.minecraft.data.BlockFamily.Builder $$1 = new net.minecraft.data.BlockFamily.Builder($$0);
      net.minecraft.data.BlockFamily $$2 = MAP.put($$0, $$1.getFamily());
      if ($$2 != null) {
   ...
   public static Stream<net.minecraft.data.BlockFamily> getAllFamilies() {
