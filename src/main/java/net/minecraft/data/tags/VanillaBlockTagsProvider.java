...
public class VanillaBlockTagsProvider extends IntrinsicHolderTagsProvider<Block> {
   public VanillaBlockTagsProvider(net.minecraft.data.PackOutput $$0, CompletableFuture<Provider> $$1) {
   ...
   protected void addTags(Provider $$0) {
      ...
      this.tag(BlockTags.REPLACEABLE)
         .addAll($$0.lookupOrThrow(Registries.BLOCK).listElements().<Block>map(Reference::value).filter($$0x -> $$0x.defaultBlockState().canBeReplaced()));
