...
public class BiomeTagsProvider extends KeyTagProvider<Biome> {
   public BiomeTagsProvider(net.minecraft.data.PackOutput $$0, CompletableFuture<Provider> $$1) {
   ...
   protected void addTags(Provider $$0) {
      ...
      this.tag(BiomeTags.IS_NETHER).addAll(Preset.NETHER.usedBiomes());
      List<ResourceKey<Biome>> $$1 = Preset.OVERWORLD.usedBiomes().toList();
