...
public class NetherPlacements {
   ...
   public static void bootstrap(BootstrapContext<PlacedFeature> $$0) {
      ...
      PlacementUtils.register(
         $$0, GLOWSTONE_EXTRA, $$7, CountPlacement.of(BiasedToBottomInt.of(0, 9)), InSquarePlacement.spread(), PlacementUtils.RANGE_4_4, BiomeFilter.biome()
      );
      ...
      PlacementUtils.register(
         $$0, SPRING_CLOSED_DOUBLE, $$16, CountPlacement.of(32), InSquarePlacement.spread(), PlacementUtils.RANGE_10_10, BiomeFilter.biome()
      );
