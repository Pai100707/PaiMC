...
public class VillagePlacements {
   ...
   public static void bootstrap(BootstrapContext<PlacedFeature> $$0) {
      ...
      PlacementUtils.register($$0, PILE_HAY_VILLAGE, $$2);
      PlacementUtils.register($$0, PILE_MELON_VILLAGE, $$3);
      PlacementUtils.register($$0, PILE_SNOW_VILLAGE, $$4);
      PlacementUtils.register($$0, PILE_ICE_VILLAGE, $$5);
      PlacementUtils.register($$0, PILE_PUMPKIN_VILLAGE, $$6);
      ...
      PlacementUtils.register($$0, PATCH_CACTUS_VILLAGE, $$11);
      PlacementUtils.register($$0, FLOWER_PLAIN_VILLAGE, $$12);
      PlacementUtils.register($$0, PATCH_TAIGA_GRASS_VILLAGE, $$13);
      PlacementUtils.register($$0, PATCH_BERRY_BUSH_VILLAGE, $$14);
   }
}
