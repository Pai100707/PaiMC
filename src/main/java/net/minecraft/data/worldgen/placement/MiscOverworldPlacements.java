...
public class MiscOverworldPlacements {
   ...
   public static void bootstrap(BootstrapContext<PlacedFeature> $$0) {
      ...
      PlacementUtils.register(
         ...
         SurfaceRelativeThresholdFilter.of(Types.OCEAN_FLOOR_WG, Integer.MIN_VALUE, -5),
         BiomeFilter.biome()
      );
      PlacementUtils.register(
         $$0,
      ...
      PlacementUtils.register(
         ...
         BlockPredicateFilter.forPredicate(BlockPredicate.matchesFluids(new Fluid[]{Fluids.WATER})),
         BiomeFilter.biome()
      );
      PlacementUtils.register(
         $$0,
      ...
      PlacementUtils.register(
         ...
         PlacementUtils.HEIGHTMAP_TOP_SOLID,
         RandomOffsetPlacement.vertical(ConstantInt.of(-1)),
         BlockPredicateFilter.forPredicate(BlockPredicate.matchesBlocks(new Block[]{Blocks.MUD})),
         BiomeFilter.biome()
      );
