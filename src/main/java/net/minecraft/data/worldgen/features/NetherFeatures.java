   ...
   public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> $$0) {
      ...
      FeatureUtils.register(
         ...
         new SpringConfiguration(
            ...
            1,
            HolderSet.direct(
               Block::builtInRegistryHolder, new Block[]{Blocks.NETHERRACK, Blocks.SOUL_SAND, Blocks.GRAVEL, Blocks.MAGMA_BLOCK, Blocks.BLACKSTONE}
            )
         )
      );
      FeatureUtils.register(
         ...
         Feature.SPRING,
         new SpringConfiguration(Fluids.LAVA.defaultFluidState(), false, 5, 0, HolderSet.direct(Block::builtInRegistryHolder, new Block[]{Blocks.NETHERRACK}))
      );
      FeatureUtils.register(
         $$0,
         SPRING_NETHER_OPEN,
         Feature.SPRING,
         new SpringConfiguration(Fluids.LAVA.defaultFluidState(), false, 4, 1, HolderSet.direct(Block::builtInRegistryHolder, new Block[]{Blocks.NETHERRACK}))
      );
      FeatureUtils.register(
         $$0,
         PATCH_FIRE,
