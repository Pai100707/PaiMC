...
public class TreeFeatures {
   ...
   private static TreeConfigurationBuilder createStraightBlobTree(Block $$0, Block $$1, int $$2, int $$3, int $$4, int $$5) {
   ...
   private static FallenTreeConfigurationBuilder createFallenOak() {
      return createFallenTrees(Blocks.OAK_LOG, 4, 7).stumpDecorators(ImmutableList.of(TrunkVineDecorator.INSTANCE));
   }

   private static FallenTreeConfigurationBuilder createFallenBirch(int $$0) {
      return createFallenTrees(Blocks.BIRCH_LOG, 5, $$0);
   }

   private static FallenTreeConfigurationBuilder createFallenJungle() {
      return createFallenTrees(Blocks.JUNGLE_LOG, 4, 11).stumpDecorators(ImmutableList.of(TrunkVineDecorator.INSTANCE));
   }

   private static FallenTreeConfigurationBuilder createFallenSpruce() {
      return createFallenTrees(Blocks.SPRUCE_LOG, 6, 10);
   }

   private static FallenTreeConfigurationBuilder createFallenTrees(Block $$0, int $$1, int $$2) {
      return new FallenTreeConfigurationBuilder(BlockStateProvider.simple($$0), UniformInt.of($$1, $$2))
         .logDecorators(
            ImmutableList.of(
               new AttachedToLogsDecorator(
                  0.1F,
                  new WeightedStateProvider(
                     WeightedList.builder().add(Blocks.RED_MUSHROOM.defaultBlockState(), 2).add(Blocks.BROWN_MUSHROOM.defaultBlockState(), 1)
                  ),
   ...
   private static TreeConfigurationBuilder cherry() {
      return new TreeConfigurationBuilder(
            ...
            new CherryTrunkPlacer(
               ...
               1,
               0,
               new WeightedListInt(WeightedList.builder().add(ConstantInt.of(1), 1).add(ConstantInt.of(2), 1).add(ConstantInt.of(3), 1).build()),
               UniformInt.of(2, 4),
               UniformInt.of(-4, -3),
               UniformInt.of(-1, 0)
            ),
   ...
   public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> $$0) {
      ...
      FeatureUtils.register(
         ...
         new HugeMushroomFeatureConfiguration(
            BlockStateProvider.simple(
               (BlockState)((BlockState)Blocks.BROWN_MUSHROOM_BLOCK.defaultBlockState().setValue(HugeMushroomBlock.UP, true))
                  .setValue(HugeMushroomBlock.DOWN, false)
            ),
            BlockStateProvider.simple(
               (BlockState)((BlockState)Blocks.MUSHROOM_STEM.defaultBlockState().setValue(HugeMushroomBlock.UP, false)).setValue(HugeMushroomBlock.DOWN, false)
            ),
            3
         )
      );
      ...
      FeatureUtils.register(
         ...
         new TreeConfigurationBuilder(
               ...
               new WeightedStateProvider(
                  WeightedList.builder().add(Blocks.AZALEA_LEAVES.defaultBlockState(), 3).add(Blocks.FLOWERING_AZALEA_LEAVES.defaultBlockState(), 1)
               ),
               ...
               List.of(
                  ...
                  new AttachedToLeavesDecorator(
                     ...
                     new RandomizedIntStateProvider(
                        BlockStateProvider.simple((BlockState)Blocks.MANGROVE_PROPAGULE.defaultBlockState().setValue(MangrovePropaguleBlock.HANGING, true)),
