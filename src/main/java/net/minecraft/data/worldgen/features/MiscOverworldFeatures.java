...
public class MiscOverworldFeatures {
   ...
   public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> $$0) {
      ...
      FeatureUtils.register(
         ...
         LAKE_LAVA,
         Feature.LAKE,
         new Configuration(BlockStateProvider.simple(Blocks.LAVA.defaultBlockState()), BlockStateProvider.simple(Blocks.STONE.defaultBlockState()))
      );
      FeatureUtils.register(
         $$0,
         DISK_CLAY,
      ...
      FeatureUtils.register(
         ...
         new DiskConfiguration(
            new RuleBasedBlockStateProvider(
               ...
               List.of(
                  new Rule(BlockPredicate.matchesBlocks(Direction.DOWN.getUnitVec3i(), new Block[]{Blocks.AIR}), BlockStateProvider.simple(Blocks.SANDSTONE))
               )
            ),
                  ...
                  new Rule(
                     BlockPredicate.not(
                        BlockPredicate.anyOf(
                           ...
                           BlockPredicate.matchesFluids(Direction.UP.getUnitVec3i(), new Fluid[]{Fluids.WATER})
                        )
                     ),
      ...
      FeatureUtils.register(
         ...
         new SpringConfiguration(
            ...
            HolderSet.direct(
               ...
               new Block[]{Blocks.STONE, Blocks.GRANITE, Blocks.DIORITE, Blocks.ANDESITE, Blocks.DEEPSLATE, Blocks.TUFF, Blocks.CALCITE, Blocks.DIRT}
            )
         )
      );
      FeatureUtils.register(
         ...
         new SpringConfiguration(
            ...
            4,
            1,
            HolderSet.direct(Block::builtInRegistryHolder, new Block[]{Blocks.SNOW_BLOCK, Blocks.POWDER_SNOW, Blocks.PACKED_ICE})
         )
      );
      FeatureUtils.register(
         $$0,
