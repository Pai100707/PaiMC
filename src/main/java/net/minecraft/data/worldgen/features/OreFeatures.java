...
public class OreFeatures {
   ...
   public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> $$0) {
      ...
      List<TargetBlockState> $$6 = List.of(
      ...
      List<TargetBlockState> $$7 = List.of(
      ...
      List<TargetBlockState> $$8 = List.of(
      ...
      List<TargetBlockState> $$9 = List.of(
      ...
      List<TargetBlockState> $$10 = List.of(
      ...
      List<TargetBlockState> $$11 = List.of(
