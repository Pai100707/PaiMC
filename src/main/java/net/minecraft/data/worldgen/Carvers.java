...
public class Carvers {
   ...
   private static ResourceKey<ConfiguredWorldCarver<?>> createKey(String $$0) {
      return ResourceKey.create(Registries.CONFIGURED_CARVER, Identifier.withDefaultNamespace($$0));
   }
         ...
         WorldCarver.CANYON
            .configured(
               new CanyonCarverConfiguration(
                  ...
                  new CanyonShapeConfiguration(UniformFloat.of(0.75F, 1.0F), TrapezoidFloat.of(0.0F, 6.0F, 2.0F), 3, UniformFloat.of(0.75F, 1.0F), 1.0F, 0.0F)
               )
            )
      );
      $$0.register(
