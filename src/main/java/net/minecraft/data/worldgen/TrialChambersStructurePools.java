...
public class TrialChambersStructurePools {
   ...
   public static void bootstrap(BootstrapContext<StructureTemplatePool> $$0) {
      ...
      Pools.register(
         ...
         new StructureTemplatePool($$2, List.of(Pair.of(StructurePoolElement.single("trial_chambers/chamber/entrance_cap", $$5), 1)), Projection.RIGID)
      );
      Pools.register(
         $$0,
      ...
      Pools.register(
         ...
         new StructureTemplatePool($$2, List.of(Pair.of(StructurePoolElement.single("trial_chambers/decor/disposal"), 1)), Projection.RIGID)
      );
      Pools.register(
         $$0,
      ...
      Pools.register(
         ...
         new StructureTemplatePool($$2, List.of(Pair.of(StructurePoolElement.single("trial_chambers/reward/vault"), 1)), Projection.RIGID)
      );
      Pools.register(
         $$0,
         "trial_chambers/reward/ominous_vault",
         new StructureTemplatePool($$2, List.of(Pair.of(StructurePoolElement.single("trial_chambers/reward/ominous_vault"), 1)), Projection.RIGID)
      );
      Pools.register(
         $$0,
      ...
      Pools.register(
         ...
         new StructureTemplatePool($$2, List.of(Pair.of(StructurePoolElement.single("trial_chambers/chests/connectors/supply"), 1)), Projection.RIGID)
      );
      Pools.register(
         $$0,
         "trial_chambers/chests/contents/supply",
         new StructureTemplatePool($$2, List.of(Pair.of(StructurePoolElement.single("trial_chambers/chests/supply"), 1)), Projection.RIGID)
      );
      Pools.register(
         $$0,
         "trial_chambers/spawner/ranged",
         new StructureTemplatePool($$2, List.of(Pair.of(StructurePoolElement.single("trial_chambers/spawner/connectors/ranged"), 1)), Projection.RIGID)
      );
      Pools.register(
         $$0,
         "trial_chambers/spawner/slow_ranged",
         new StructureTemplatePool($$2, List.of(Pair.of(StructurePoolElement.single("trial_chambers/spawner/connectors/slow_ranged"), 1)), Projection.RIGID)
      );
      Pools.register(
         $$0,
         "trial_chambers/spawner/melee",
         new StructureTemplatePool($$2, List.of(Pair.of(StructurePoolElement.single("trial_chambers/spawner/connectors/melee"), 1)), Projection.RIGID)
      );
      Pools.register(
         $$0,
         "trial_chambers/spawner/small_melee",
         new StructureTemplatePool($$2, List.of(Pair.of(StructurePoolElement.single("trial_chambers/spawner/connectors/small_melee"), 1)), Projection.RIGID)
      );
      Pools.register(
         $$0,
         "trial_chambers/spawner/breeze",
         new StructureTemplatePool($$2, List.of(Pair.of(StructurePoolElement.single("trial_chambers/spawner/connectors/breeze"), 1)), Projection.RIGID)
      );
      Pools.register(
         $$0,
      ...
      Pools.register(
         ...
         new StructureTemplatePool($$2, List.of(Pair.of(StructurePoolElement.single("trial_chambers/spawner/breeze/breeze"), 1)), Projection.RIGID)
      );
      Pools.register(
         $$0,
