...
public class DimensionTypes {
   public static void bootstrap(BootstrapContext<DimensionType> $$0) {
      ...
      EnvironmentAttributeMap $$2 = EnvironmentAttributeMap.builder()
      ...
      $$0.register(
         ...
         new DimensionType(
            ...
            0.0F,
            new MonsterSettings(UniformInt.of(0, 7), 0),
            Skybox.OVERWORLD,
            CardinalLightType.DEFAULT,
            $$2,
            $$1.getOrThrow(TimelineTags.IN_OVERWORLD)
         )
      );
      $$0.register(
         ...
         new DimensionType(
            ...
            0.1F,
            new MonsterSettings(ConstantInt.of(7), 15),
            Skybox.NONE,
            CardinalLightType.NETHER,
            EnvironmentAttributeMap.builder()
               ...
               .build(),
            $$1.getOrThrow(TimelineTags.IN_NETHER)
         )
      );
      $$0.register(
         ...
         new DimensionType(
            ...
            0.25F,
            new MonsterSettings(ConstantInt.of(15), 0),
            Skybox.END,
            CardinalLightType.DEFAULT,
            EnvironmentAttributeMap.builder()
               ...
               .set(EnvironmentAttributes.RESPAWN_ANCHOR_WORKS, false)
               .build(),
            $$1.getOrThrow(TimelineTags.IN_END)
         )
      );
      $$0.register(
