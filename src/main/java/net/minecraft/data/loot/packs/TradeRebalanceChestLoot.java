...
public record TradeRebalanceChestLoot(Provider registries) implements LootTableSubProvider {
   @Override
                     ...
                     LootItem.lootTableItem(Items.BOOK)
                        ...
                        .apply(
                           new net.minecraft.world.level.storage.loot.functions.EnchantRandomlyFunction.Builder()
                              .withEnchantment($$1.getOrThrow(Enchantments.EFFICIENCY))
                        )
                  )
            )
      );
   ...
   public Builder pillagerOutpostLootTable() {
            ...
            LootPool.lootPool()
               ...
               .add(
                  LootItem.lootTableItem(Items.BOOK)
                     ...
                     .apply(
                        new net.minecraft.world.level.storage.loot.functions.EnchantRandomlyFunction.Builder()
                           .withEnchantment($$0.getOrThrow(Enchantments.QUICK_CHARGE))
                     )
               )
         );
   }

   public Builder desertPyramidLootTable() {
      RegistryLookup<Enchantment> $$0 = this.registries.lookupOrThrow(Registries.ENCHANTMENT);
      return LootTable.lootTable()
         .withPool(
            LootPool.lootPool()
            ...
            LootPool.lootPool()
               ...
               .add(
                  LootItem.lootTableItem(Items.BOOK)
                     ...
                     .apply(
                        new net.minecraft.world.level.storage.loot.functions.EnchantRandomlyFunction.Builder()
                           .withEnchantment($$0.getOrThrow(Enchantments.UNBREAKING))
                     )
               )
         );
   }

   public Builder ancientCityLootTable() {
      RegistryLookup<Enchantment> $$0 = this.registries.lookupOrThrow(Registries.ENCHANTMENT);
      return LootTable.lootTable()
         .withPool(
            LootPool.lootPool()
               ...
               .add(
                  LootItem.lootTableItem(Items.BOOK)
                     ...
                     .apply(
                        new net.minecraft.world.level.storage.loot.functions.EnchantRandomlyFunction.Builder()
                           .withEnchantment($$0.getOrThrow(Enchantments.SWIFT_SNEAK))
                     )
               )
            ...
            LootPool.lootPool()
               ...
               .add(
                  LootItem.lootTableItem(Items.BOOK)
                     ...
                     .apply(
                        new net.minecraft.world.level.storage.loot.functions.EnchantRandomlyFunction.Builder()
                           .withEnchantment($$0.getOrThrow(Enchantments.MENDING))
                     )
               )
   ...
   public Builder jungleTempleLootTable() {
      RegistryLookup<Enchantment> $$0 = this.registries.lookupOrThrow(Registries.ENCHANTMENT);
      return LootTable.lootTable()
         .withPool(
            LootPool.lootPool()
