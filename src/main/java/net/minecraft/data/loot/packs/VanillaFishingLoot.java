...
public record VanillaFishingLoot(Provider registries) implements LootTableSubProvider {
   @Override
   public void generate(BiConsumer<ResourceKey<LootTable>, Builder> $$0) {
      RegistryLookup<Biome> $$1 = this.registries.lookupOrThrow(Registries.BIOME);
      $$0.accept(
                     ...
                     NestedLootTable.lootTableReference(BuiltInLootTables.FISHING_TREASURE)
                        ...
                        .when(
                           LootItemEntityPropertyCondition.hasProperties(
                              EntityTarget.THIS,
                              net.minecraft.advancements.criterion.EntityPredicate.Builder.entity().subPredicate(FishingHookPredicate.inOpenWater(true))
                           )
                        )
                  )
         ...
         LootTable.lootTable()
            .withPool(
               LootPool.lootPool()
                  ...
                  .add(
                     ((net.minecraft.world.level.storage.loot.entries.LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Blocks.BAMBOO)
                           .when(
   ...
   public static Builder fishingFishLootTable() {
