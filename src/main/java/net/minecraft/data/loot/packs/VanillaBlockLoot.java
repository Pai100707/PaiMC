...
public class VanillaBlockLoot extends BlockLootSubProvider {
   ...
   public VanillaBlockLoot(Provider $$0) {
   ...
   protected void generate() {
      ...
      RegistryLookup<Item> $$1 = this.registries.lookupOrThrow(Registries.ITEM);
                        ...
                        LootItem.lootTableItem(Blocks.TNT)
                           .when(
                              LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.TNT)
                                 .setProperties(Builder.properties().hasProperty(TntBlock.UNSTABLE, false))
                           )
                     )
               )
            )
                              ...
                              SetItemCountFunction.setCount(ConstantValue.exactly(3.0F))
                                 .when(
                                    LootItemBlockStatePropertyCondition.hasBlockStateProperties($$0x)
                                       .setProperties(Builder.properties().hasProperty(CocoaBlock.AGE, 2))
                                 )
                           )
                     )
                  )
                  ...
                  .add(
                     this.applyExplosionDecay(
                        ...
                        LootItem.lootTableItem($$0x)
                           .apply(
                              List.of(2, 3, 4),
                              $$1x -> SetItemCountFunction.setCount(ConstantValue.exactly($$1x.intValue()))
                                 .when(
                                    LootItemBlockStatePropertyCondition.hasBlockStateProperties($$0x)
                                       .setProperties(Builder.properties().hasProperty(SeaPickleBlock.PICKLES, $$1x))
                                 )
                           )
                     )
                  )
         ...
         $$0x -> LootTable.lootTable()
            ...
            .withPool(
               LootPool.lootPool()
                  ...
                  .when(
                     LootItemBlockStatePropertyCondition.hasBlockStateProperties($$0x).setProperties(Builder.properties().hasProperty(ComposterBlock.LEVEL, 8))
                  )
            )
      );
      ...
      net.minecraft.world.level.storage.loot.predicates.LootItemCondition.Builder $$2 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(
            Blocks.BEETROOTS
         )
         .setProperties(Builder.properties().hasProperty(BeetrootBlock.AGE, 3));
      this.add(Blocks.BEETROOTS, this.createCropDrops(Blocks.BEETROOTS, Items.BEETROOT, Items.BEETROOT_SEEDS, $$2));
      net.minecraft.world.level.storage.loot.predicates.LootItemCondition.Builder $$3 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(
            Blocks.WHEAT
         )
         .setProperties(Builder.properties().hasProperty(CropBlock.AGE, 7));
      this.add(Blocks.WHEAT, this.createCropDrops(Blocks.WHEAT, Items.WHEAT, Items.WHEAT_SEEDS, $$3));
      net.minecraft.world.level.storage.loot.predicates.LootItemCondition.Builder $$4 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(
            Blocks.CARROTS
         )
         .setProperties(Builder.properties().hasProperty(CarrotBlock.AGE, 7));
      net.minecraft.world.level.storage.loot.predicates.LootItemCondition.Builder $$5 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(
                        ...
                        LootItem.lootTableItem(Items.PITCHER_PLANT)
                           .when(
                              LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.PITCHER_PLANT)
                                 .setProperties(Builder.properties().hasProperty(DoublePlantBlock.HALF, DoubleBlockHalf.LOWER))
                           )
                     )
               )
         )
      ...
      net.minecraft.world.level.storage.loot.predicates.LootItemCondition.Builder $$6 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(
            Blocks.POTATOES
         )
         .setProperties(Builder.properties().hasProperty(PotatoBlock.AGE, 7));
      this.add(
         Blocks.POTATOES,
         this.applyExplosionDecay(
            Blocks.POTATOES,
      ...
      this.add(Blocks.COBWEB, $$0x -> this.createSilkTouchOrShearsDispatchTable($$0x, this.applyExplosionCondition($$0x, LootItem.lootTableItem(Items.STRING))));
      this.add(
         Blocks.DEAD_BUSH,
               ...
               LootPool.lootPool()
                  ...
                  .add(
                     ((net.minecraft.world.level.storage.loot.entries.LootPoolSingletonContainer.Builder)this.applyExplosionCondition(
                           $$0x, LootItem.lootTableItem($$0x)
                        ))
                        .when(LootItemEntityPropertyCondition.entityPresent(EntityTarget.THIS))
                  )
            )
      );
                              ...
                              SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F))
                                 .when(
                                    LootItemBlockStatePropertyCondition.hasBlockStateProperties($$1x)
                                       .setProperties(Builder.properties().hasProperty(NetherWartBlock.AGE, 3))
                                 )
                           )
                           .apply(
                     ...
                     AlternativesEntry.alternatives(
                        new net.minecraft.world.level.storage.loot.entries.LootPoolEntryContainer.Builder[]{
                           AlternativesEntry.alternatives(
                                 ...
                                 $$1x -> ((net.minecraft.world.level.storage.loot.entries.LootPoolSingletonContainer.Builder)LootItem.lootTableItem(
                                          Items.SNOWBALL
                                       )
                                       .when(
                                          LootItemBlockStatePropertyCondition.hasBlockStateProperties($$0x)
                                             .setProperties(Builder.properties().hasProperty(SnowLayerBlock.LAYERS, $$1x))
                                       ))
                                    .apply(SetItemCountFunction.setCount(ConstantValue.exactly($$1x.intValue())))
                              )
                              .when(this.doesNotHaveSilkTouch()),
                           AlternativesEntry.alternatives(
                              SnowLayerBlock.LAYERS.getPossibleValues(),
                              $$1x -> (net.minecraft.world.level.storage.loot.entries.LootPoolEntryContainer.Builder)($$1x == 8
      ...
      this.add(
         ...
         $$1x -> this.createSilkTouchDispatchTable(
            ...
            this.applyExplosionCondition(
               $$1x,
               ((net.minecraft.world.level.storage.loot.entries.LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.FLINT)
                     .when(BonusLevelTableCondition.bonusLevelFlatChance($$0.getOrThrow(Enchantments.FORTUNE), new float[]{0.1F, 0.14285715F, 0.25F, 1.0F})))
      ...
      this.add(
         ...
         $$0x -> this.createSilkTouchDispatchTable(
            $$0x, this.applyExplosionCondition($$0x, LootItem.lootTableItem(Items.CHARCOAL).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F))))
         )
      );
      this.add(
         ...
         $$1x -> this.createSilkTouchDispatchTable(
            ...
            this.applyExplosionCondition(
               $$1x,
               ((net.minecraft.world.level.storage.loot.entries.LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.GOLD_NUGGET)
      ...
      this.add(
         ...
         $$0x -> this.createSilkTouchDispatchTable(
            $$0x, this.applyExplosionCondition($$0x, LootItem.lootTableItem(Items.SOUL_SOIL).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))))
         )
      );
      this.add(
         ...
         $$2x -> this.createSilkTouchDispatchTable(
            $$2x,
            ((net.minecraft.world.level.storage.loot.entries.LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.AMETHYST_SHARD)
                  .apply(SetItemCountFunction.setCount(ConstantValue.exactly(4.0F)))
                  .apply(ApplyBonusCount.addOreBonusCount($$0.getOrThrow(Enchantments.FORTUNE)))
                  .when(MatchTool.toolMatches(net.minecraft.advancements.criterion.ItemPredicate.Builder.item().of($$1, ItemTags.CLUSTER_MAX_HARVESTABLES))))
               .otherwise(
                  this.applyExplosionDecay($$2x, LootItem.lootTableItem(Items.AMETHYST_SHARD).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F))))
               )
         )
      );
   ...
   private net.minecraft.world.level.storage.loot.LootTable.Builder createDecoratedPotTable(Block $$0) {
      return LootTable.lootTable()
         .withPool(
            LootPool.lootPool()
               .setRolls(ConstantValue.exactly(1.0F))
               .add(
                  ((net.minecraft.world.level.storage.loot.entries.LootPoolSingletonContainer.Builder)DynamicLoot.dynamicEntry(
                           DecoratedPotBlock.SHERDS_DYNAMIC_DROP_ID
                        )
                        .when(
                           LootItemBlockStatePropertyCondition.hasBlockStateProperties($$0)
                              .setProperties(Builder.properties().hasProperty(DecoratedPotBlock.CRACKED, true))
                        ))
                     .otherwise(
   ...
   private net.minecraft.world.level.storage.loot.LootTable.Builder createPitcherCropLoot() {
               ...
               LootPool.lootPool()
                  .add(
                     AlternativesEntry.alternatives(
                        ...
                        $$0 -> {
                           net.minecraft.world.level.storage.loot.predicates.LootItemBlockStatePropertyCondition.Builder $$1 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(
                                 Blocks.PITCHER_CROP
                              )
                              .setProperties(Builder.properties().hasProperty(DoublePlantBlock.HALF, DoubleBlockHalf.LOWER));
                           net.minecraft.world.level.storage.loot.predicates.LootItemBlockStatePropertyCondition.Builder $$2 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(
                                 Blocks.PITCHER_CROP
                              )
                              .setProperties(Builder.properties().hasProperty(PitcherCropBlock.AGE, $$0));
                           return $$0 == 4
   ...
   private net.minecraft.world.level.storage.loot.LootTable.Builder createMobSkullDrop(Block $$0) {
      return LootTable.lootTable()
         .withPool(
            this.applyExplosionCondition(
               $$0,
