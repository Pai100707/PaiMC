...
public record VanillaGiftLoot(Provider registries) implements LootTableSubProvider {
   @Override
                                          ...
                                          net.minecraft.advancements.criterion.DataComponentMatchers.Builder.components()
                                             .exact(
                                                DataComponentExactPredicate.expect(
                                                   DataComponents.CHICKEN_VARIANT, new EitherHolder($$1.getOrThrow(ChickenVariants.TEMPERATE))
                                                )
                                             )
                                             .build()
                                       )
                                    ...
                                    net.minecraft.advancements.criterion.EntityPredicate.Builder.entity()
                                       .components(
                                          net.minecraft.advancements.criterion.DataComponentMatchers.Builder.components()
                                             .exact(
                                                DataComponentExactPredicate.expect(
                                                   DataComponents.CHICKEN_VARIANT, new EitherHolder($$1.getOrThrow(ChickenVariants.WARM))
                                                )
                                             )
                                             .build()
                                       )
                                    ...
                                    net.minecraft.advancements.criterion.EntityPredicate.Builder.entity()
                                       .components(
                                          net.minecraft.advancements.criterion.DataComponentMatchers.Builder.components()
                                             .exact(
                                                DataComponentExactPredicate.expect(
                                                   DataComponents.CHICKEN_VARIANT, new EitherHolder($$1.getOrThrow(ChickenVariants.COLD))
                                                )
                                             )
                                             .build()
                                       )
