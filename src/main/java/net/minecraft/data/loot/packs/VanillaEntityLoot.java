...
public class VanillaEntityLoot extends EntityLootSubProvider {
   public VanillaEntityLoot(Provider $$0) {
         ...
         LootTable.lootTable()
            ...
            .withPool(
               LootPool.lootPool()
                  ...
                  .when(LootItemEntityPropertyCondition.hasProperties(EntityTarget.ATTACKER, Builder.entity().of($$0, EntityTypeTags.SKELETONS)))
            )
      );
      this.add(
         EntityType.DOLPHIN,
                  ...
                  .when(
                     DamageSourceCondition.hasDamageSource(
                        net.minecraft.advancements.criterion.DamageSourcePredicate.Builder.damageType()
                           ...
                           .direct(Builder.entity().of($$0, EntityType.FIREBALL))
                     )
                  )
                  .when(LootItemKilledByPlayerCondition.killedByPlayer())
            )
                     ...
                     LootItem.lootTableItem(Items.RABBIT_FOOT)
                        ...
                        .when(
                           LootItemEntityPropertyCondition.hasProperties(
                              EntityTarget.THIS,
                              Builder.entity().vehicle(Builder.entity().entityType(EntityTypePredicate.of($$0, EntityType.CAMEL_HUSK))).build()
                           )
                        )
                  )
            )
         ...
         LootTable.lootTable()
            .withPool(
               LootPool.lootPool()
                  .setRolls(ConstantValue.exactly(1.0F))
                  .add(
                     ((net.minecraft.world.level.storage.loot.entries.LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.MAGMA_CREAM)
                           .apply(SetItemCountFunction.setCount(UniformGenerator.between(-2.0F, 1.0F)))
                           .apply(EnchantedCountIncreaseFunction.lootingMultiplier(this.registries, UniformGenerator.between(0.0F, 1.0F)))
                           .when(this.killedByFrog($$0).invert()))
                        .when(
                           LootItemEntityPropertyCondition.hasProperties(
                              EntityTarget.THIS, Builder.entity().subPredicate(SlimePredicate.sized(Ints.atLeast(2)))
                           )
                        )
                  )
                  .add(
         ...
         LootTable.lootTable()
            .withPool(
               LootPool.lootPool()
                  ...
                  .when(LootItemEntityPropertyCondition.hasProperties(EntityTarget.THIS, Builder.entity().subPredicate(SlimePredicate.sized(Ints.exactly(1)))))
            )
      );
         ...
         LootTable.lootTable()
            ...
            .withPool(
               LootPool.lootPool()
                  ...
                  .when(
                     DamageSourceCondition.hasDamageSource(
                        net.minecraft.advancements.criterion.DamageSourcePredicate.Builder.damageType().tag(TagPredicate.is(DamageTypeTags.IS_LIGHTNING))
                     )
                  )
            )
      );
                  ...
                  .add(
                     LootItem.lootTableItem(Items.RED_MUSHROOM)
                        ...
                        .when(
                           LootItemEntityPropertyCondition.hasProperties(
                              EntityTarget.THIS,
                              Builder.entity().vehicle(Builder.entity().entityType(EntityTypePredicate.of($$0, EntityType.ZOMBIE_HORSE))).build()
                           )
                        )
                  )
            )
                  ...
                  .when(
                     LootItemEntityPropertyCondition.hasProperties(
                        ...
                        Builder.entity()
                           ...
                           .vehicle(Builder.entity().of($$0, EntityType.CHICKEN))
                     )
                  )
            )
      );
   ...
   public net.minecraft.world.level.storage.loot.LootTable.Builder elderGuardianLootTable() {
