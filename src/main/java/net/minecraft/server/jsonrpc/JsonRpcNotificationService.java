...
public class JsonRpcNotificationService implements NotificationService {
   ...
   private void broadcastNotification(Reference<? extends OutgoingRpcMethod<Void, ?>> $$0) {
      this.managementServer.forEachConnection($$1 -> $$1.sendNotification($$0));
   }

   private <Params> void broadcastNotification(Reference<? extends OutgoingRpcMethod<Params, ?>> $$0, Params $$1) {
