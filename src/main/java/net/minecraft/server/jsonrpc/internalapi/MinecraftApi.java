...
public class MinecraftApi {
   ...
   public MinecraftApi(
      ...
      MinecraftAllowListService $$1,
      MinecraftBanListService $$2,
      MinecraftPlayerListService $$3,
      MinecraftGameRuleService $$4,
      MinecraftOperatorListService $$5,
      MinecraftServerSettingsService $$6,
      MinecraftServerStateService $$7,
      MinecraftExecutorService $$8
   ) {
   ...
   public static MinecraftApi of(DedicatedServer $$0) {
      ...
      MinecraftExecutorService $$9 = new MinecraftExecutorServiceImpl($$0);
