...
public class JsonRpcApiSchema implements DataProvider {
   ...
   public JsonRpcApiSchema(PackOutput $$0) {
      this.path = $$0.getOutputFolder(Target.REPORTS).resolve("json-rpc-api-schema.json");
   }
   ...
   public CompletableFuture<?> run(CachedOutput $$0) {
      ...
      return DataProvider.saveStable(
         $$0, (JsonElement)DiscoveryService.DiscoverResponse.CODEC.codec().encodeStart(JsonOps.INSTANCE, $$1).getOrThrow(), this.path
      );
   }
