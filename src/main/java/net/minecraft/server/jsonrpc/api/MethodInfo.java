...
public record MethodInfo<Params, Result>(String description, Optional<ParamInfo<Params>> params, Optional<ResultInfo<Result>> result) {
   ...
   private static <Params> List<ParamInfo<Params>> toList(Optional<ParamInfo<Params>> $$0) {
      return $$0.isPresent() ? List.of($$0.get()) : List.of();
   }
   ...
   public MethodInfo.Named<Params, Result> named(Identifier $$0) {
   ...
   public record Named<Params, Result>(Identifier name, MethodInfo<Params, Result> contents) {
      ...
      public static <Params, Result> Codec<MethodInfo.Named<Params, Result>> typedCodec() {
         return RecordCodecBuilder.create(
            $$0 -> $$0.group(Identifier.CODEC.fieldOf("name").forGetter(MethodInfo.Named::name), MethodInfo.typedCodec().forGetter(MethodInfo.Named::contents))
