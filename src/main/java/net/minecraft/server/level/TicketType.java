...
public record TicketType(long timeout, @TicketType.Flags int flags) {
   ...
   private static TicketType register(String $$0, long $$1, @TicketType.Flags int $$2) {
      return (TicketType)Registry.register(BuiltInRegistries.TICKET_TYPE, $$0, new TicketType($$1, $$2));
   }
