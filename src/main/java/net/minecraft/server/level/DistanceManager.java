...
public abstract class DistanceManager {
         ...
         if (!this.ticketsToRelease.isEmpty()) {
            ...
            while ($$5.hasNext()) {
               ...
               if (this.ticketStorage.getTickets($$6).stream().anyMatch($$0x -> $$0x.getType() == TicketType.PLAYER_LOADING)) {
                  ...
                  $$8.thenAccept($$1x -> this.mainThreadExecutor.execute(() -> this.ticketDispatcher.release($$6, () -> {}, false)));
               }
            }
   ...
   public void addPlayer(SectionPos $$0, ServerPlayer $$1) {
      ChunkPos $$2 = $$0.chunk();
      long $$3 = $$2.toLong();
      ((ObjectSet)this.playersPerChunk.computeIfAbsent($$3, $$0x -> new ObjectOpenHashSet())).add($$1);
   ...
   class FixedPlayerDistanceChunkTracker extends ChunkTracker {
      ...
      protected FixedPlayerDistanceChunkTracker(final int $$0) {
         super($$0 + 2, 16, 256);
         this.maxDistance = $$0;
      ...
      private boolean havePlayer(long $$0) {
         ObjectSet<ServerPlayer> $$1 = (ObjectSet<ServerPlayer>)DistanceManager.this.playersPerChunk.get($$0);
   ...
   class PlayerTicketTracker extends DistanceManager.FixedPlayerDistanceChunkTracker {
      ...
      protected PlayerTicketTracker(final int $$0) {
         super($$0);
         this.viewDistance = 0;
