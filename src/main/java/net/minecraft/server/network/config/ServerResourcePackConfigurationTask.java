...
public class ServerResourcePackConfigurationTask implements ConfigurationTask {
   ...
   private final net.minecraft.server.MinecraftServer.ServerResourcePackInfo info;

   public ServerResourcePackConfigurationTask(net.minecraft.server.MinecraftServer.ServerResourcePackInfo $$0) {
      this.info = $$0;
   }
