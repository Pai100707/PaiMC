...
public class ForceLoadCommand {
   ...
   private static final Dynamic2CommandExceptionType ERROR_TOO_MANY_CHUNKS = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> Component.translatableEscape("commands.forceload.toobig", new Object[]{$$0, $$1})
   );
   private static final Dynamic2CommandExceptionType ERROR_NOT_TICKING = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> Component.translatableEscape("commands.forceload.query.failure", new Object[]{$$0, $$1})
   );
   ...
   public static void register(CommandDispatcher<CommandSourceStack> $$0) {
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("forceload")
            ...
            .then(
               ((LiteralArgumentBuilder)Commands.literal("query").executes($$0x -> listForceLoad((CommandSourceStack)$$0x.getSource())))
                  .then(
      ...
      if ($$5) {
         $$0.sendSuccess(
            () -> Component.translatable(
               "commands.forceload.query.success", new Object[]{Component.translationArg($$2), Component.translationArg($$4.identifier())}
            ),
            false
         );
         return 1;
      } else {
         throw ERROR_NOT_TICKING.create($$2, $$4.identifier());
      }
   }
   ...
   private static int listForceLoad(CommandSourceStack $$0) {
      ...
      if ($$4 > 0) {
         ...
         if ($$4 == 1) {
            $$0.sendSuccess(
               () -> Component.translatable("commands.forceload.list.single", new Object[]{Component.translationArg($$2.identifier()), $$5}), false
            );
         } else {
            $$0.sendSuccess(
               () -> Component.translatable("commands.forceload.list.multiple", new Object[]{$$4, Component.translationArg($$2.identifier()), $$5}), false
            );
         }
      } else {
         $$0.sendFailure(Component.translatable("commands.forceload.added.none", new Object[]{Component.translationArg($$2.identifier())}));
      }
   ...
   private static int removeAll(CommandSourceStack $$0) {
      ...
      $$0.sendSuccess(() -> Component.translatable("commands.forceload.removed.all", new Object[]{Component.translationArg($$2.identifier())}), true);
      return 0;
   }
               ...
               if ($$21 == 1) {
                  $$0.sendSuccess(
                     () -> Component.translatable(
                        ...
                        new Object[]{Component.translationArg($$20), Component.translationArg($$14.identifier())}
                     ),
                     true
                  );
               } else {
                  ...
                  $$0.sendSuccess(
                     () -> Component.translatable(
                        ...
                        new Object[]{$$21, Component.translationArg($$14.identifier()), Component.translationArg($$22), Component.translationArg($$23)}
                     ),
                     true
                  );
               }
