...
public class RecipeCommand {
   ...
   private static int giveRecipes(CommandSourceStack $$0, Collection<ServerPlayer> $$1, Collection<RecipeHolder<?>> $$2) throws CommandSyntaxException {
      ...
      if ($$3 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.sendSuccess(
               () -> Component.translatable("commands.recipe.give.success.single", new Object[]{$$2.size(), $$1.iterator().next().getDisplayName()}), true
            );
         } else {
            $$0.sendSuccess(() -> Component.translatable("commands.recipe.give.success.multiple", new Object[]{$$2.size(), $$1.size()}), true);
         }
   ...
   private static int takeRecipes(CommandSourceStack $$0, Collection<ServerPlayer> $$1, Collection<RecipeHolder<?>> $$2) throws CommandSyntaxException {
      ...
      if ($$3 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.sendSuccess(
               () -> Component.translatable("commands.recipe.take.success.single", new Object[]{$$2.size(), $$1.iterator().next().getDisplayName()}), true
            );
         } else {
            $$0.sendSuccess(() -> Component.translatable("commands.recipe.take.success.multiple", new Object[]{$$2.size(), $$1.size()}), true);
         }
