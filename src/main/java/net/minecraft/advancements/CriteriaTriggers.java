...
public class CriteriaTriggers {
   public static final Codec<net.minecraft.advancements.CriterionTrigger<?>> CODEC = BuiltInRegistries.TRIGGER_TYPES.byNameCodec();
   ...
   private static <T extends net.minecraft.advancements.CriterionTrigger<?>> T register(String $$0, T $$1) {
      return (T)Registry.register(BuiltInRegistries.TRIGGER_TYPES, $$0, $$1);
   }

   public static net.minecraft.advancements.CriterionTrigger<?> bootstrap(Registry<net.minecraft.advancements.CriterionTrigger<?>> $$0) {
      return IMPOSSIBLE;
   }
}
