...
public class ColorArgument implements ArgumentType<ChatFormatting> {
   ...
   public static final DynamicCommandExceptionType ERROR_INVALID_VALUE = new DynamicCommandExceptionType(
      $$0 -> Component.translatableEscape("argument.color.invalid", new Object[]{$$0})
   );
   ...
   public static ChatFormatting getColor(CommandContext<net.minecraft.commands.CommandSourceStack> $$0, String $$1) {
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> $$0, SuggestionsBuilder $$1) {
      return net.minecraft.commands.SharedSuggestionProvider.suggest(ChatFormatting.getNames(true, false), $$1);
   }
