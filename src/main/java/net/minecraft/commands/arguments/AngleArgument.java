...
public class AngleArgument implements ArgumentType<AngleArgument.SingleAngle> {
   ...
   public static float getAngle(CommandContext<net.minecraft.commands.CommandSourceStack> $$0, String $$1) {
      return ((AngleArgument.SingleAngle)$$0.getArgument($$1, AngleArgument.SingleAngle.class))
         .getAngle((net.minecraft.commands.CommandSourceStack)$$0.getSource());
   }
