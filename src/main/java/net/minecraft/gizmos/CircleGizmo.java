...
public record CircleGizmo(Vec3 pos, float radius, net.minecraft.gizmos.GizmoStyle style) implements net.minecraft.gizmos.Gizmo {
   ...
   public void emit(net.minecraft.gizmos.GizmoPrimitives $$0, float $$1) {
      if (this.style.hasStroke() || this.style.hasFill()) {
         ...
         for (int $$3 = 0; $$3 < 20; $$3++) {
            float $$4 = $$3 * (float) (Math.PI / 10);
            Vec3 $$5 = this.pos.add((float)(this.radius * Math.cos($$4)), 0.0, (float)(this.radius * Math.sin($$4)));
            $$2[$$3] = $$5;
         }
