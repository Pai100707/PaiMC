...
public record RecipeDisplayEntry(
   ...
   public List<net.minecraft.world.item.ItemStack> resultItems(ContextMap $$0) {
      return this.display.result().resolveForStacks($$0);
   }

   public boolean canCraft(StackedItemContents $$0) {
      return this.craftingRequirements.isEmpty() ? false : $$0.canCraft(this.craftingRequirements.get(), null);
   }
}
