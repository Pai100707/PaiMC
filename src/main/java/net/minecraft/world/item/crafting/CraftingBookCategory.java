...
public enum CraftingBookCategory implements StringRepresentable {
   ...
   public static final IntFunction<CraftingBookCategory> BY_ID = ByIdMap.continuous(CraftingBookCategory::id, values(), OutOfBoundsStrategy.ZERO);
   ...
   private CraftingBookCategory(final String $$0, final int $$1) {
      this.name = $$0;
      this.id = $$1;
   }
