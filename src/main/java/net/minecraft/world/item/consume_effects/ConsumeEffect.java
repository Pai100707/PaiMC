...
public interface ConsumeEffect {
   ...
   boolean apply(Level var1, net.minecraft.world.item.ItemStack var2, LivingEntity var3);
   ...
   public record Type<T extends ConsumeEffect>(MapCodec<T> codec, StreamCodec<RegistryFriendlyByteBuf, T> streamCodec) {
      ...
      private static <T extends ConsumeEffect> ConsumeEffect.Type<T> register(String $$0, MapCodec<T> $$1, StreamCodec<RegistryFriendlyByteBuf, T> $$2) {
         return (ConsumeEffect.Type<T>)Registry.register(BuiltInRegistries.CONSUME_EFFECT_TYPE, $$0, new ConsumeEffect.Type($$1, $$2));
      }
   }
}
