...
public class ExperienceBottleItem extends net.minecraft.world.item.Item implements net.minecraft.world.item.ProjectileItem {
   public ExperienceBottleItem(net.minecraft.world.item.Item.Properties $$0) {
      super($$0);
   }
