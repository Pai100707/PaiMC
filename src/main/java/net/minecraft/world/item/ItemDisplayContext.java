...
public enum ItemDisplayContext implements StringRepresentable {
   ...
   public static final Codec<net.minecraft.world.item.ItemDisplayContext> CODEC = StringRepresentable.fromEnum(
      net.minecraft.world.item.ItemDisplayContext::values
   );
   public static final IntFunction<net.minecraft.world.item.ItemDisplayContext> BY_ID = ByIdMap.continuous(
      net.minecraft.world.item.ItemDisplayContext::getId, values(), OutOfBoundsStrategy.ZERO
   );
   private final byte id;
   private final String name;

   private ItemDisplayContext(final int $$0, final String $$1) {
      this.name = $$1;
      this.id = (byte)$$0;
   }
