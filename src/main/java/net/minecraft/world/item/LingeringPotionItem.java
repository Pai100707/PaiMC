...
public class LingeringPotionItem extends net.minecraft.world.item.ThrowablePotionItem {
   public LingeringPotionItem(net.minecraft.world.item.Item.Properties $$0) {
      super($$0);
   }
