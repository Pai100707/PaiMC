...
public class Enchantments {
   ...
   public static void bootstrap(BootstrapContext<Enchantment> $$0) {
      ...
      HolderGetter<net.minecraft.world.item.Item> $$3 = $$0.lookup(Registries.ITEM);
      ...
      register(
         ...
         Enchantment.enchantment(
               Enchantment.definition(
                  $$3.getOrThrow(ItemTags.ARMOR_ENCHANTABLE), 5, 4, Enchantment.dynamicCost(10, 8), Enchantment.dynamicCost(18, 8), 2, EquipmentSlotGroup.ARMOR
               )
            )
            .exclusiveWith($$2.getOrThrow(EnchantmentTags.ARMOR_EXCLUSIVE))
            .withEffect(
      ...
      net.minecraft.advancements.criterion.EntityPredicate.Builder $$6 = net.minecraft.advancements.criterion.EntityPredicate.Builder.entity()
         .periodicTick(5)
         ...
         .movementAffectedBy(
            net.minecraft.advancements.criterion.LocationPredicate.Builder.location()
               .setBlock(net.minecraft.advancements.criterion.BlockPredicate.Builder.block().of($$4, BlockTags.SOUL_SPEED_BLOCKS))
         );
      net.minecraft.world.level.storage.loot.predicates.AllOfCondition.Builder $$7 = AllOfCondition.allOf(
         new net.minecraft.world.level.storage.loot.predicates.LootItemCondition.Builder[]{
            InvertedLootItemCondition.invert(
               LootItemEntityPropertyCondition.hasProperties(
                  EntityTarget.THIS,
      ...
      register(
         ...
         Enchantment.enchantment(
            ...
            .withEffect(
               ...
               LootItemEntityPropertyCondition.hasProperties(EntityTarget.THIS, $$6)
            )
            .withEffect(
               EnchantmentEffectComponents.TICK,
               ...
               AllOfCondition.allOf(
                  new net.minecraft.world.level.storage.loot.predicates.LootItemCondition.Builder[]{
                     LootItemRandomChanceCondition.randomChance(0.35F), LootItemEntityPropertyCondition.hasProperties(EntityTarget.THIS, $$6)
                  }
               )
            )
      );
      ...
      register(
         ...
         Enchantment.enchantment(
               Enchantment.definition(
                  ...
                  $$3.getOrThrow(ItemTags.MELEE_WEAPON_ENCHANTABLE),
                  10,
                  5,
                  Enchantment.dynamicCost(1, 11),
         ...
         Enchantment.enchantment(
            ...
            .withEffect(
               ...
               LootItemEntityPropertyCondition.hasProperties(
                  EntityTarget.THIS,
                  net.minecraft.advancements.criterion.EntityPredicate.Builder.entity()
                     .entityType(EntityTypePredicate.of($$5, EntityTypeTags.SENSITIVE_TO_SMITE))
               )
            )
      );
      register(
         ...
         Enchantment.enchantment(
            ...
            .withEffect(
               ...
               LootItemEntityPropertyCondition.hasProperties(
                  EntityTarget.THIS,
                  net.minecraft.advancements.criterion.EntityPredicate.Builder.entity()
                     .entityType(EntityTypePredicate.of($$5, EntityTypeTags.SENSITIVE_TO_BANE_OF_ARTHROPODS))
               )
            )
            .withEffect(
               EnchantmentEffectComponents.POST_ATTACK,
               ...
               EnchantmentTarget.VICTIM,
               new ApplyMobEffect(
                  HolderSet.direct(new Holder[]{MobEffects.SLOWNESS}),
         ...
         Enchantment.enchantment(
            ...
            .withEffect(
               ...
               LootItemEntityPropertyCondition.hasProperties(
                  ...
                  net.minecraft.advancements.criterion.EntityPredicate.Builder.entity().entityType(EntityTypePredicate.of($$5, EntityType.PLAYER))
               )
            )
      );
      register(
         ...
         Enchantment.enchantment(
               Enchantment.definition(
                  $$3.getOrThrow(ItemTags.SWEEPING_ENCHANTABLE),
                  2,
                  3,
      ...
      register(
         ...
         Enchantment.enchantment(
            ...
            .withEffect(
               ...
               MatchTool.toolMatches(net.minecraft.advancements.criterion.ItemPredicate.Builder.item().of($$3, ItemTags.ARMOR_ENCHANTABLE))
            )
            .withEffect(
               EnchantmentEffectComponents.ITEM_DAMAGE,
      ...
      register(
         ...
         Enchantment.enchantment(
            ...
            .withEffect(
               ...
               LootItemEntityPropertyCondition.hasProperties(
                  EntityTarget.DIRECT_ATTACKER, net.minecraft.advancements.criterion.EntityPredicate.Builder.entity().of($$5, EntityTypeTags.ARROWS).build()
               )
            )
      );
      register(
         ...
         Enchantment.enchantment(
            ...
            .withEffect(
               ...
               MatchTool.toolMatches(
                  net.minecraft.advancements.criterion.ItemPredicate.Builder.item().of($$3, new ItemLike[]{net.minecraft.world.item.Items.ARROW})
               )
            )
      );
      register(
         ...
         Enchantment.enchantment(
            ...
            .withEffect(
               ...
               LootItemEntityPropertyCondition.hasProperties(
                  EntityTarget.THIS,
                  net.minecraft.advancements.criterion.EntityPredicate.Builder.entity()
                     .entityType(EntityTypePredicate.of($$5, EntityTypeTags.SENSITIVE_TO_IMPALING))
                     .build()
               )
            )
      );
      ...
      register(
         ...
         Enchantment.enchantment(
               Enchantment.definition(
                  $$3.getOrThrow(ItemTags.LUNGE_ENCHANTABLE), 5, 3, Enchantment.dynamicCost(5, 8), Enchantment.dynamicCost(25, 8), 2, EquipmentSlotGroup.HAND
               )
            )
            .withEffect(
      ...
      register(
         ...
         Enchantment.enchantment(
            ...
            .withEffect(
               ...
               EnchantmentTarget.VICTIM,
               AllOf.entityEffects(
                  new SummonEntityEffect(HolderSet.direct(new Holder[]{EntityType.LIGHTNING_BOLT.builtInRegistryHolder()}), false),
               ...
               AllOfCondition.allOf(
                  new net.minecraft.world.level.storage.loot.predicates.LootItemCondition.Builder[]{
                     ...
                     LootItemEntityPropertyCondition.hasProperties(
                        EntityTarget.DIRECT_ATTACKER, net.minecraft.advancements.criterion.EntityPredicate.Builder.entity().of($$5, EntityType.TRIDENT)
                     )
                  }
               )
            )
            .withEffect(
               ...
               AllOfCondition.allOf(
                  new net.minecraft.world.level.storage.loot.predicates.LootItemCondition.Builder[]{
                     WeatherCheck.weather().setThundering(true),
                     LootItemEntityPropertyCondition.hasProperties(
                        EntityTarget.THIS, net.minecraft.advancements.criterion.EntityPredicate.Builder.entity().of($$5, EntityType.TRIDENT)
                     ),
                     LocationCheck.checkLocation(
                        net.minecraft.advancements.criterion.LocationPredicate.Builder.location()
                           .setCanSeeSky(true)
                           .setBlock(net.minecraft.advancements.criterion.BlockPredicate.Builder.block().of($$4, BlockTags.LIGHTNING_RODS))
                     )
                  }
               )
            )
      ...
      register(
         ...
         Enchantment.enchantment(
            ...
            .withSpecialEffect(
               ...
               List.of(
                  new net.minecraft.world.item.CrossbowItem.ChargingSounds(
   ...
   private static void register(BootstrapContext<Enchantment> $$0, ResourceKey<Enchantment> $$1, Enchantment.Builder $$2) {
      $$0.register($$1, $$2.build($$1.identifier()));
   }

   private static ResourceKey<Enchantment> key(String $$0) {
      return ResourceKey.create(Registries.ENCHANTMENT, Identifier.withDefaultNamespace($$0));
   }
}
