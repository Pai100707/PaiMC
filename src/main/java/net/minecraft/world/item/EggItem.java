...
public class EggItem extends net.minecraft.world.item.Item implements net.minecraft.world.item.ProjectileItem {
   public static final float PROJECTILE_SHOOT_POWER = 1.5F;

   public EggItem(net.minecraft.world.item.Item.Properties $$0) {
      super($$0);
   }
