...
public interface EquipmentAssets {
   ...
   Map<net.minecraft.world.item.DyeColor, ResourceKey<EquipmentAsset>> CARPETS = Util.makeEnumMap(
      net.minecraft.world.item.DyeColor.class, $$0 -> createId($$0.getSerializedName() + "_carpet")
   );
   ResourceKey<EquipmentAsset> TRADER_LLAMA = createId("trader_llama");
   Map<net.minecraft.world.item.DyeColor, ResourceKey<EquipmentAsset>> HARNESSES = Util.makeEnumMap(
      net.minecraft.world.item.DyeColor.class, $$0 -> createId($$0.getSerializedName() + "_harness")
   );
