...
public class Stopwatches extends SavedData {
   ...
   private static Stopwatches unpack(Map<Identifier, Long> $$0) {
      ...
      long $$2 = currentTime();
      $$0.forEach(($$2x, $$3) -> $$1.stopwatches.put($$2x, new Stopwatch($$2, $$3)));
      return $$1;
   }
   ...
   private Map<Identifier, Long> pack() {
      ...
      this.stopwatches.forEach(($$2, $$3) -> $$1.put($$2, $$3.elapsedMilliseconds($$0)));
      return $$1;
   }
   ...
   public boolean update(Identifier $$0, UnaryOperator<Stopwatch> $$1) {
      if (this.stopwatches.computeIfPresent($$0, ($$1x, $$2) -> $$1.apply($$2)) != null) {
         this.setDirty();
         return true;
      } else {
         return false;
