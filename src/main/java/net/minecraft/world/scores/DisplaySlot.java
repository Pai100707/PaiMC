...
public enum DisplaySlot implements StringRepresentable {
   ...
   public static final EnumCodec<net.minecraft.world.scores.DisplaySlot> CODEC = StringRepresentable.fromEnum(net.minecraft.world.scores.DisplaySlot::values);
   public static final IntFunction<net.minecraft.world.scores.DisplaySlot> BY_ID = ByIdMap.continuous(
      net.minecraft.world.scores.DisplaySlot::id, values(), OutOfBoundsStrategy.ZERO
   );
   private final int id;
   private final String name;

   private DisplaySlot(final int $$0, final String $$1) {
      this.id = $$0;
      this.name = $$1;
   }
