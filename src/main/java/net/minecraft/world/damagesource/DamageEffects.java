...
public enum DamageEffects implements StringRepresentable {
   ...
   public static final Codec<net.minecraft.world.damagesource.DamageEffects> CODEC = StringRepresentable.fromEnum(
      net.minecraft.world.damagesource.DamageEffects::values
   );
   private final String id;
   private final SoundEvent sound;

   private DamageEffects(final String $$0, final SoundEvent $$1) {
      this.id = $$0;
      this.sound = $$1;
   }
