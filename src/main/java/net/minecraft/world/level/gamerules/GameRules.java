...
public class GameRules {
   ...
   public static Codec<GameRules> codec(FeatureFlagSet $$0) {
      return GameRuleMap.CODEC.xmap($$1 -> new GameRules($$0, $$1), $$0x -> $$0x.rules);
   }

   public GameRules(FeatureFlagSet $$0, GameRuleMap $$1) {
      this($$0);
      this.rules.setFromIf($$1, this.rules::has);
   }

   public GameRules(FeatureFlagSet $$0) {
      this.rules = GameRuleMap.of(BuiltInRegistries.GAME_RULE.filterFeatures($$0).listElements().map(Holder::value));
   }
   ...
   private static GameRule<Boolean> registerBoolean(String $$0, GameRuleCategory $$1, boolean $$2) {
      return register(
         $$0, $$1, GameRuleType.BOOL, BoolArgumentType.bool(), Codec.BOOL, $$2, FeatureFlagSet.of(), GameRuleTypeVisitor::visitBoolean, $$0x -> $$0x ? 1 : 0
      );
   }
   ...
   private static GameRule<Integer> registerInteger(String $$0, GameRuleCategory $$1, int $$2, int $$3, int $$4, FeatureFlagSet $$5) {
      return register(
         $$0, $$1, GameRuleType.INT, IntegerArgumentType.integer($$3, $$4), Codec.intRange($$3, $$4), $$2, $$5, GameRuleTypeVisitor::visitInteger, $$0x -> $$0x
      );
   }
   ...
   private static <T> GameRule<T> register(
      ...
      T $$5,
      FeatureFlagSet $$6,
      GameRules.VisitorCaller<T> $$7,
      ToIntFunction<T> $$8
   ) {
      return (GameRule<T>)Registry.register(BuiltInRegistries.GAME_RULE, $$0, new GameRule<>($$1, $$2, $$3, $$7, $$4, $$8, $$5, $$6));
   }
   ...
   public <T> String getAsString(GameRule<T> $$0) {
      return $$0.serialize(this.get($$0));
   }
