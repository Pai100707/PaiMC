...
public class MapDecorationTypes {
   ...
   private static Holder<MapDecorationType> register(String $$0, String $$1, boolean $$2, int $$3, boolean $$4, boolean $$5) {
      ResourceKey<MapDecorationType> $$6 = ResourceKey.create(Registries.MAP_DECORATION_TYPE, Identifier.withDefaultNamespace($$0));
      MapDecorationType $$7 = new MapDecorationType(Identifier.withDefaultNamespace($$1), $$2, $$3, $$5, $$4);
