...
public enum MoonPhase implements StringRepresentable {
   ...
   public static final Codec<net.minecraft.world.level.MoonPhase> CODEC = StringRepresentable.fromEnum(net.minecraft.world.level.MoonPhase::values);
   public static final int COUNT = values().length;
   public static final int PHASE_LENGTH = 24000;
   private final int index;
   private final String name;

   private MoonPhase(final int $$0, final String $$1) {
      this.index = $$0;
      this.name = $$1;
   }
