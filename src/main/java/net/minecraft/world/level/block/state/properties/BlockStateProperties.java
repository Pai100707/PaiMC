...
public class BlockStateProperties {
   ...
   public static final EnumProperty<Direction> HORIZONTAL_FACING = EnumProperty.create("facing", Direction.class, Plane.HORIZONTAL);
   ...
   public static final EnumProperty<RailShape> RAIL_SHAPE_STRAIGHT = EnumProperty.create(
      "shape", RailShape.class, $$0 -> $$0 != RailShape.NORTH_EAST && $$0 != RailShape.NORTH_WEST && $$0 != RailShape.SOUTH_EAST && $$0 != RailShape.SOUTH_WEST
   );
