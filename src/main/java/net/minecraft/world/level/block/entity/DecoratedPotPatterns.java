...
public class DecoratedPotPatterns {
   ...
   private static ResourceKey<DecoratedPotPattern> create(String $$0) {
      return ResourceKey.create(Registries.DECORATED_POT_PATTERN, Identifier.withDefaultNamespace($$0));
   }
   ...
   private static DecoratedPotPattern register(Registry<DecoratedPotPattern> $$0, ResourceKey<DecoratedPotPattern> $$1, String $$2) {
      return (DecoratedPotPattern)Registry.register($$0, $$1, new DecoratedPotPattern(Identifier.withDefaultNamespace($$2)));
   }
}
