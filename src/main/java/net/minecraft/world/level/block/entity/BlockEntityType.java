...
public class BlockEntityType<T extends BlockEntity> {
   ...
   private static <T extends BlockEntity> BlockEntityType<T> register(String $$0, BlockEntityType.BlockEntitySupplier<? extends T> $$1, Block... $$2) {
      ...
      return (BlockEntityType<T>)Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, $$0, new BlockEntityType<>($$1, Set.of($$2)));
   }
   ...
   public T create(BlockPos $$0, BlockState $$1) {
      return (T)this.factory.create($$0, $$1);
   }
   ...
   @Deprecated
   public Reference<BlockEntityType<?>> builtInRegistryHolder() {
