...
public final class RegionFileStorage implements AutoCloseable {
   ...
   private RegionFile getRegionFile(net.minecraft.world.level.ChunkPos $$0) throws IOException {
      long $$1 = net.minecraft.world.level.ChunkPos.asLong($$0.getRegionX(), $$0.getRegionZ());
   ...
   public void scanChunk(net.minecraft.world.level.ChunkPos $$0, StreamTagVisitor $$1) throws IOException {
