...
public class FlatLevelGeneratorPresets {
   ...
   private static ResourceKey<FlatLevelGeneratorPreset> register(String $$0) {
      return ResourceKey.create(Registries.FLAT_LEVEL_GENERATOR_PRESET, Identifier.withDefaultNamespace($$0));
   }
   ...
   static class Bootstrap {
      ...
      private void register(
         ...
         net.minecraft.world.level.ItemLike $$1,
         ResourceKey<Biome> $$2,
         ...
         Direct<StructureSet> $$10 = HolderSet.direct($$3.stream().map($$7::getOrThrow).collect(Collectors.toList()));
