...
public class Noises {
   ...
   private static ResourceKey<NormalNoise.NoiseParameters> createKey(String $$0) {
      return ResourceKey.create(Registries.NOISE, Identifier.withDefaultNamespace($$0));
   }
   ...
   public static NormalNoise instantiate(
      ...
      return NormalNoise.create($$1.fromHashOf(((ResourceKey)$$3.unwrapKey().orElseThrow()).identifier()), (NormalNoise.NoiseParameters)$$3.value());
   }
}
