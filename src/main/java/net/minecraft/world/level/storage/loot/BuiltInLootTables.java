...
public class BuiltInLootTables {
   ...
   private static ResourceKey<LootTable> register(String $$0) {
      return register(ResourceKey.create(Registries.LOOT_TABLE, Identifier.withDefaultNamespace($$0)));
   }
   ...
   private static ResourceKey<LootTable> register(ResourceKey<LootTable> $$0) {
      if (LOCATIONS.add($$0)) {
         ...
         throw new IllegalArgumentException($$0.identifier() + " is already a registered built-in loot table");
      }
   }
