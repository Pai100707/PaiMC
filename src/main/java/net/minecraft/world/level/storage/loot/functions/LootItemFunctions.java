...
public class LootItemFunctions {
   ...
   private static <T extends LootItemFunction> LootItemFunctionType<T> register(String $$0, MapCodec<T> $$1) {
      return (LootItemFunctionType<T>)Registry.register(
         BuiltInRegistries.LOOT_FUNCTION_TYPE, Identifier.withDefaultNamespace($$0), new LootItemFunctionType($$1)
      );
   }
   ...
   public static BiFunction<ItemStack, LootContext, ItemStack> compose(List<? extends BiFunction<ItemStack, LootContext, ItemStack>> $$0) {
      ...
      return switch ($$1.size()) {
         ...
         case 2 -> {
            BiFunction<ItemStack, LootContext, ItemStack> $$2 = $$1.get(0);
            BiFunction<ItemStack, LootContext, ItemStack> $$3 = $$1.get(1);
            yield ($$2x, $$3x) -> $$3.apply($$2.apply($$2x, $$3x), $$3x);
         }
         default -> ($$1x, $$2x) -> {
            for (BiFunction<ItemStack, LootContext, ItemStack> $$3x : $$1) {
               $$1x = $$3x.apply($$1x, $$2x);
            }
