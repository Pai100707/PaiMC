...
public class NumberProviders {
   ...
   private static LootNumberProviderType register(String $$0, MapCodec<? extends NumberProvider> $$1) {
      return (LootNumberProviderType)Registry.register(
         BuiltInRegistries.LOOT_NUMBER_PROVIDER_TYPE, Identifier.withDefaultNamespace($$0), new LootNumberProviderType($$1)
      );
   }
}
