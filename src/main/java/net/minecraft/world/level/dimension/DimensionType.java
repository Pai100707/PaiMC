...
public record DimensionType(
   ...
   private static Codec<DimensionType> createDirectCodec(Codec<EnvironmentAttributeMap> $$0) {
      return ExtraCodecs.catchDecoderException(
         RecordCodecBuilder.create(
            $$1 -> $$1.group(
                  ...
                  $$0.optionalFieldOf("attributes", EnvironmentAttributeMap.EMPTY).forGetter(DimensionType::attributes),
   ...
   public static Path getStorageFolder(ResourceKey<net.minecraft.world.level.Level> $$0, Path $$1) {
      if ($$0 == net.minecraft.world.level.Level.OVERWORLD) {
         return $$1;
      } else if ($$0 == net.minecraft.world.level.Level.END) {
         return $$1.resolve("DIM1");
      } else {
         return $$0 == net.minecraft.world.level.Level.NETHER
            ? $$1.resolve("DIM-1")
            : $$1.resolve("dimensions").resolve($$0.identifier().getNamespace()).resolve($$0.identifier().getPath());
      }
   }
   ...
   public static enum CardinalLightType implements StringRepresentable {
      ...
      private CardinalLightType(final String $$0) {
         this.name = $$0;
      }
