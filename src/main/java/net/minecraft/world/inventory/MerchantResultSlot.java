...
public class MerchantResultSlot extends net.minecraft.world.inventory.Slot {
   private final net.minecraft.world.inventory.MerchantContainer slots;
   private final Player player;
   private int removeCount;
   private final Merchant merchant;

   public MerchantResultSlot(Player $$0, Merchant $$1, net.minecraft.world.inventory.MerchantContainer $$2, int $$3, int $$4, int $$5) {
      super($$2, $$3, $$4, $$5);
      this.player = $$0;
      this.merchant = $$1;
      this.slots = $$2;
