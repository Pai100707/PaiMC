...
public class HorseInventoryMenu extends net.minecraft.world.inventory.AbstractMountInventoryMenu {
   ...
   public HorseInventoryMenu(int $$0, Inventory $$1, Container $$2, final AbstractHorse $$3, int $$4) {
      ...
      this.addSlot(new net.minecraft.world.inventory.ArmorSlot($$8, $$3, EquipmentSlot.BODY, 0, 8, 36, $$7) {
         @Override
         public boolean isActive() {
      ...
      if ($$4 > 0) {
         for (int $$9 = 0; $$9 < 3; $$9++) {
            for (int $$10 = 0; $$10 < $$4; $$10++) {
               this.addSlot(new net.minecraft.world.inventory.Slot($$2, $$10 + $$9 * $$4, 80 + $$10 * 18, 18 + $$9 * 18));
            }
         }
      }
