...
class WeavingMobEffect extends net.minecraft.world.effect.MobEffect {
   private final ToIntFunction<RandomSource> maxCobwebs;

   protected WeavingMobEffect(net.minecraft.world.effect.MobEffectCategory $$0, int $$1, ToIntFunction<RandomSource> $$2) {
   ...
   public void onMobRemoved(ServerLevel $$0, LivingEntity $$1, int $$2, RemovalReason $$3) {
      if ($$3 == RemovalReason.KILLED && ($$1 instanceof Player || (Boolean)$$0.getGameRules().get(GameRules.MOB_GRIEFING))) {
   ...
   private void spawnCobwebsRandomlyAround(ServerLevel $$0, RandomSource $$1, BlockPos $$2) {
      Set<BlockPos> $$3 = Sets.newHashSet();
