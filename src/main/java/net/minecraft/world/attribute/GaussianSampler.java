...
public class GaussianSampler {
   ...
   public static <V> void sample(
      Vec3 $$0, net.minecraft.world.attribute.GaussianSampler.Sampler<V> $$1, net.minecraft.world.attribute.GaussianSampler.Accumulator<V> $$2
   ) {
