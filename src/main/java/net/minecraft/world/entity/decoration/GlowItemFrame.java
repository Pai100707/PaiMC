...
public class GlowItemFrame extends ItemFrame {
   public GlowItemFrame(net.minecraft.world.entity.EntityType<? extends ItemFrame> $$0, Level $$1) {
      super($$0, $$1);
   }

   public GlowItemFrame(Level $$0, BlockPos $$1, Direction $$2) {
      super(net.minecraft.world.entity.EntityType.GLOW_ITEM_FRAME, $$0, $$1, $$2);
   }
