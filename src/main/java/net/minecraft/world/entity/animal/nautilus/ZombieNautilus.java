...
public class ZombieNautilus extends AbstractNautilus {
   ...
   public ZombieNautilus(net.minecraft.world.entity.EntityType<? extends ZombieNautilus> $$0, Level $$1) {
      super($$0, $$1);
   }
   ...
   protected void readAdditionalSaveData(ValueInput $$0) {
      ...
      VariantUtils.<ZombieNautilusVariant>readVariant($$0, Registries.ZOMBIE_NAUTILUS_VARIANT).ifPresent(this::setVariant);
   }
   ...
   public <T> T get(DataComponentType<? extends T> $$0) {
      return $$0 == DataComponents.ZOMBIE_NAUTILUS_VARIANT
         ? castComponentValue((DataComponentType<T>)$$0, new EitherHolder(this.getVariant()))
         : super.get($$0);
   }
   ...
   protected <T> boolean applyImplicitComponent(DataComponentType<T> $$0, T $$1) {
      if ($$0 == DataComponents.ZOMBIE_NAUTILUS_VARIANT) {
         Optional<Holder<ZombieNautilusVariant>> $$2 = castComponentValue(DataComponents.ZOMBIE_NAUTILUS_VARIANT, $$1).unwrap(this.registryAccess());
         if ($$2.isPresent()) {
