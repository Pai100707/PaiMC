...
public enum CopperGolemState implements StringRepresentable {
   ...
   private static final IntFunction<CopperGolemState> BY_ID = ByIdMap.continuous(CopperGolemState::id, values(), OutOfBoundsStrategy.ZERO);
   ...
   private CopperGolemState(final String $$0, final int $$1) {
      this.name = $$0;
      this.id = $$1;
   }
