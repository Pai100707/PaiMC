...
public class CopperGolemOxidationLevels {
   ...
   private static final Map<WeatherState, CopperGolemOxidationLevel> WEATHERED_STATES = Map.of(
      WeatherState.UNAFFECTED, UNAFFECTED, WeatherState.EXPOSED, EXPOSED, WeatherState.WEATHERED, WEATHERED, WeatherState.OXIDIZED, OXIDIZED
   );

   public static CopperGolemOxidationLevel getOxidationLevel(WeatherState $$0) {
