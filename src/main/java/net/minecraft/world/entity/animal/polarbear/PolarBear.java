...
public class PolarBear extends Animal implements net.minecraft.world.entity.NeutralMob {
      ...
      this.goalSelector
         .addGoal(
            ...
            new PanicGoal(
               this,
               2.0,
               (Function<net.minecraft.world.entity.PathfinderMob, TagKey<DamageType>>)($$0 -> $$0.isBaby()
   ...
   public static boolean checkPolarBearSpawnRules(
      net.minecraft.world.entity.EntityType<PolarBear> $$0, LevelAccessor $$1, net.minecraft.world.entity.EntitySpawnReason $$2, BlockPos $$3, RandomSource $$4
   ) {
      Holder<Biome> $$5 = $$1.getBiome($$3);
      return !$$5.is(BiomeTags.POLAR_BEARS_SPAWN_ON_ALTERNATE_BLOCKS)
         ? checkAnimalSpawnRules($$0, $$1, $$2, $$3, $$4)
         : isBrightEnoughToSpawn($$1, $$3) && $$1.getBlockState($$3.below()).is(BlockTags.POLAR_BEARS_SPAWNABLE_ON_ALTERNATE);
   }
   ...
   class PolarBearMeleeAttackGoal extends MeleeAttackGoal {
      ...
      protected void checkAndPerformAttack(net.minecraft.world.entity.LivingEntity $$0) {
         ...
         } else if (this.mob.distanceToSqr($$0) < ($$0.getBbWidth() + 3.0F) * ($$0.getBbWidth() + 3.0F)) {
