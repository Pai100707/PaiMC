...
public class Armadillo extends Animal {
   ...
   public final net.minecraft.world.entity.AnimationState rollOutAnimationState = new net.minecraft.world.entity.AnimationState();
   public final net.minecraft.world.entity.AnimationState rollUpAnimationState = new net.minecraft.world.entity.AnimationState();
   public final net.minecraft.world.entity.AnimationState peekAnimationState = new net.minecraft.world.entity.AnimationState();
   private int scuteTime;
   private boolean peekReceivedClient = false;

   public Armadillo(net.minecraft.world.entity.EntityType<? extends Animal> $$0, Level $$1) {
      super($$0, $$1);
   ...
   protected void customServerAiStep(ServerLevel $$0) {
      ...
      ((Brain<Armadillo>)this.brain).tick($$0, this);
      $$1.pop();
      $$1.push("armadilloActivityUpdate");
      ArmadilloAi.updateActivity(this);
      $$1.pop();
      if (this.isAlive() && --this.scuteTime <= 0 && this.shouldDropLoot($$0)) {
   ...
   public static boolean checkArmadilloSpawnRules(
      net.minecraft.world.entity.EntityType<Armadillo> $$0, LevelAccessor $$1, net.minecraft.world.entity.EntitySpawnReason $$2, BlockPos $$3, RandomSource $$4
   ) {
      return $$1.getBlockState($$3.below()).is(BlockTags.ARMADILLO_SPAWNABLE_ON) && isBrightEnoughToSpawn($$1, $$3);
   }

   public boolean isScaredBy(net.minecraft.world.entity.LivingEntity $$0) {
      if (!this.getBoundingBox().inflate(7.0, 2.0, 7.0).intersects($$0.getBoundingBox())) {
         ...
         return $$1.isSpectator() ? false : $$1.isSprinting() || $$1.isPassenger();
      } else {
         return false;
      }
   }
   ...
   protected void readAdditionalSaveData(ValueInput $$0) {
      ...
      this.switchToState($$0.read("state", Armadillo.ArmadilloState.CODEC).orElse(Armadillo.ArmadilloState.IDLE));
   ...
   protected void actuallyHurt(ServerLevel $$0, DamageSource $$1, float $$2) {
      ...
      if (!this.isNoAi() && !this.isDeadOrDying()) {
         if ($$1.getEntity() instanceof net.minecraft.world.entity.LivingEntity) {
   ...
   public static enum ArmadilloState implements StringRepresentable {
      ...
      ArmadilloState(final String $$0, final boolean $$1, final int $$2, final int $$3) {
         this.name = $$0;
         this.isThreatened = $$1;
