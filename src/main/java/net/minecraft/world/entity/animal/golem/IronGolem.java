...
public class IronGolem extends AbstractGolem implements net.minecraft.world.entity.NeutralMob {
      ...
      this.targetSelector
         .addGoal(
            ...
            new NearestAttackableTargetGoal<>(
               this, net.minecraft.world.entity.Mob.class, 5, false, false, ($$0, $$1) -> $$0 instanceof Enemy && !($$0 instanceof Creeper)
            )
         );
   ...
   public boolean canAttackType(net.minecraft.world.entity.EntityType<?> $$0) {
      if (this.isPlayerCreated() && $$0 == net.minecraft.world.entity.EntityType.PLAYER) {
         ...
         return $$0 == net.minecraft.world.entity.EntityType.CREEPER ? false : super.canAttackType($$0);
      }
   }
   ...
   public boolean doHurtTarget(ServerLevel $$0, net.minecraft.world.entity.Entity $$1) {
      ...
      float $$3 = (int)$$2 > 0 ? $$2 / 2.0F + this.random.nextInt((int)$$2) : $$2;
      DamageSource $$4 = this.damageSources().mobAttack(this);
      boolean $$5 = $$1.hurtServer($$0, $$4, $$3);
      if ($$5) {
         double $$7 = $$1 instanceof net.minecraft.world.entity.LivingEntity $$6 ? $$6.getAttributeValue(Attributes.KNOCKBACK_RESISTANCE) : 0.0;
   ...
   public boolean hurtServer(ServerLevel $$0, DamageSource $$1, float $$2) {
      net.minecraft.world.entity.Crackiness.Level $$3 = this.getCrackiness();
   ...
   public boolean checkSpawnObstruction(LevelReader $$0) {
      ...
      if (!$$3.entityCanStandOn($$0, $$2, this)) {
         ...
         for (int $$4 = 1; $$4 < 3; $$4++) {
            ...
            if (!NaturalSpawner.isValidEmptySpawnBlock($$0, $$5, $$6, $$6.getFluidState(), net.minecraft.world.entity.EntityType.IRON_GOLEM)) {
               return false;
            }
         }

         return NaturalSpawner.isValidEmptySpawnBlock(
               $$0, $$1, $$0.getBlockState($$1), Fluids.EMPTY.defaultFluidState(), net.minecraft.world.entity.EntityType.IRON_GOLEM
            )
