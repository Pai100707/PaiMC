...
public record FrogVariant(ResourceTexture assetInfo, SpawnPrioritySelectors spawnConditions) implements PriorityProvider<SpawnContext, SpawnCondition> {
   public static final Codec<FrogVariant> DIRECT_CODEC = RecordCodecBuilder.create(
      $$0 -> $$0.group(
            ResourceTexture.DEFAULT_FIELD_CODEC.forGetter(FrogVariant::assetInfo),
   ...
   public static final Codec<FrogVariant> NETWORK_CODEC = RecordCodecBuilder.create(
      $$0 -> $$0.group(ResourceTexture.DEFAULT_FIELD_CODEC.forGetter(FrogVariant::assetInfo)).apply($$0, FrogVariant::new)
   );
   ...
   private FrogVariant(ResourceTexture $$0) {
