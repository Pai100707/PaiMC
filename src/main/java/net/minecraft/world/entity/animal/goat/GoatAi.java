...
public class GoatAi {
   ...
   private static final TargetingConditions RAM_TARGET_CONDITIONS = TargetingConditions.forCombat()
      .selector(
         ($$0, $$1) -> !$$0.getType().equals(net.minecraft.world.entity.EntityType.GOAT)
            && ((Boolean)$$1.getGameRules().get(GameRules.MOB_GRIEFING) || !$$0.getType().equals(net.minecraft.world.entity.EntityType.ARMOR_STAND))
   ...
   private static void initIdleActivity(Brain<Goat> $$0) {
      $$0.addActivityWithConditions(
         ...
         ImmutableList.of(
            ...
            Pair.of(0, new AnimalMakeLove(net.minecraft.world.entity.EntityType.GOAT)),
         ...
         ImmutableList.of(
            ...
            Pair.of(
               ...
               new LongJumpToRandomPos<>(
                  TIME_BETWEEN_LONG_JUMPS, 5, 5, 3.5714288F, $$0x -> $$0x.isScreamingGoat() ? SoundEvents.GOAT_SCREAMING_LONG_JUMP : SoundEvents.GOAT_LONG_JUMP
               )
            )
         ),
         ImmutableSet.of(
