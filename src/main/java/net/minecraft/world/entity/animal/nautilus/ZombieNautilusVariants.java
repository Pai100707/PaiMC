...
public class ZombieNautilusVariants {
   ...
   public static void bootstrap(BootstrapContext<ZombieNautilusVariant> $$0) {
      register($$0, TEMPERATE, ZombieNautilusVariant.ModelType.NORMAL, "zombie_nautilus", SpawnPrioritySelectors.fallback(0));
      register($$0, WARM, ZombieNautilusVariant.ModelType.WARM, "zombie_nautilus_coral", BiomeTags.SPAWNS_CORAL_VARIANT_ZOMBIE_NAUTILUS);
   }

   private static void register(
      BootstrapContext<ZombieNautilusVariant> $$0, ResourceKey<ZombieNautilusVariant> $$1, ZombieNautilusVariant.ModelType $$2, String $$3, TagKey<Biome> $$4
   ) {
   ...
   private static void register(
      BootstrapContext<ZombieNautilusVariant> $$0,
      ResourceKey<ZombieNautilusVariant> $$1,
      ZombieNautilusVariant.ModelType $$2,
      String $$3,
      SpawnPrioritySelectors $$4
   ) {
      Identifier $$5 = Identifier.withDefaultNamespace("entity/nautilus/" + $$3);
      $$0.register($$1, new ZombieNautilusVariant(new ModelAndTexture<>($$2, $$5), $$4));
   }
}
