...
public class CopperGolemAi {
   ...
   private static void initIdleActivity(Brain<CopperGolem> $$0) {
      $$0.addActivity(
         ...
         ImmutableList.of(
            ...
            Pair.of(1, SetEntityLookTargetSometimes.create(net.minecraft.world.entity.EntityType.PLAYER, 6.0F, UniformInt.of(40, 80))),
            Pair.of(
               2,
               new RunOne(
                  ImmutableMap.of(
   ...
   private static Consumer<net.minecraft.world.entity.PathfinderMob> onTravelling() {
      return $$0 -> {
   ...
   private static Predicate<TransportItemsBetweenContainers.TransportItemTarget> shouldQueueForTarget() {
      return $$0 -> $$0.blockEntity() instanceof ChestBlockEntity $$2 ? !$$2.getEntitiesWithContainerOpen().isEmpty() : false;
   }
}
