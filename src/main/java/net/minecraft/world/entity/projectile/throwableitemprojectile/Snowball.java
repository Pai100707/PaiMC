...
public class Snowball extends ThrowableItemProjectile {
   public Snowball(net.minecraft.world.entity.EntityType<? extends Snowball> $$0, Level $$1) {
      super($$0, $$1);
   }

   public Snowball(Level $$0, net.minecraft.world.entity.LivingEntity $$1, ItemStack $$2) {
      super(net.minecraft.world.entity.EntityType.SNOWBALL, $$1, $$0, $$2);
   }

   public Snowball(Level $$0, double $$1, double $$2, double $$3, ItemStack $$4) {
      super(net.minecraft.world.entity.EntityType.SNOWBALL, $$1, $$2, $$3, $$0, $$4);
   }
