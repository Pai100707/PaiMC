...
public abstract class ThrowableItemProjectile extends ThrowableProjectile implements ItemSupplier {
   ...
   public ThrowableItemProjectile(net.minecraft.world.entity.EntityType<? extends ThrowableItemProjectile> $$0, Level $$1) {
      super($$0, $$1);
   }

   public ThrowableItemProjectile(
      net.minecraft.world.entity.EntityType<? extends ThrowableItemProjectile> $$0, double $$1, double $$2, double $$3, Level $$4, ItemStack $$5
   ) {
      super($$0, $$1, $$2, $$3, $$4);
      this.setItem($$5);
   }
   ...
   public ThrowableItemProjectile(
      net.minecraft.world.entity.EntityType<? extends ThrowableItemProjectile> $$0, net.minecraft.world.entity.LivingEntity $$1, Level $$2, ItemStack $$3
   ) {
