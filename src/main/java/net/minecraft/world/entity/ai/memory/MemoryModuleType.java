...
public class MemoryModuleType<U> {
   ...
   public static final MemoryModuleType<List<net.minecraft.world.entity.LivingEntity>> NEAREST_LIVING_ENTITIES = register("mobs");
   public static final MemoryModuleType<NearestVisibleLivingEntities> NEAREST_VISIBLE_LIVING_ENTITIES = register("visible_mobs");
   public static final MemoryModuleType<List<net.minecraft.world.entity.LivingEntity>> VISIBLE_VILLAGER_BABIES = register("visible_villager_babies");
   ...
   public static final MemoryModuleType<net.minecraft.world.entity.LivingEntity> ATTACK_TARGET = register("attack_target");
   public static final MemoryModuleType<Boolean> ATTACK_COOLING_DOWN = register("attack_cooling_down");
   public static final MemoryModuleType<net.minecraft.world.entity.LivingEntity> INTERACTION_TARGET = register("interaction_target");
   public static final MemoryModuleType<net.minecraft.world.entity.AgeableMob> BREED_TARGET = register("breed_target");
   public static final MemoryModuleType<net.minecraft.world.entity.Entity> RIDE_TARGET = register("ride_target");
   ...
   public static final MemoryModuleType<net.minecraft.world.entity.LivingEntity> HURT_BY_ENTITY = register("hurt_by_entity");
   public static final MemoryModuleType<net.minecraft.world.entity.LivingEntity> AVOID_TARGET = register("avoid_target");
   public static final MemoryModuleType<net.minecraft.world.entity.LivingEntity> NEAREST_HOSTILE = register("nearest_hostile");
   public static final MemoryModuleType<net.minecraft.world.entity.LivingEntity> NEAREST_ATTACKABLE = register("nearest_attackable");
   ...
   public static final MemoryModuleType<net.minecraft.world.entity.LivingEntity> NEAREST_VISIBLE_ADULT = register("nearest_visible_adult");
   public static final MemoryModuleType<ItemEntity> NEAREST_VISIBLE_WANTED_ITEM = register("nearest_visible_wanted_item");
   public static final MemoryModuleType<net.minecraft.world.entity.Mob> NEAREST_VISIBLE_NEMESIS = register("nearest_visible_nemesis");
   ...
   public static final MemoryModuleType<net.minecraft.world.entity.LivingEntity> NEAREST_VISIBLE_ZOMBIFIED = register("nearest_visible_zombified");
   ...
   public static final MemoryModuleType<net.minecraft.world.entity.LivingEntity> ROAR_TARGET = register("roar_target");
   ...
   private static <U> MemoryModuleType<U> register(String $$0, Codec<U> $$1) {
      return (MemoryModuleType<U>)Registry.register(
         BuiltInRegistries.MEMORY_MODULE_TYPE, Identifier.withDefaultNamespace($$0), new MemoryModuleType(Optional.of($$1))
      );
   }

   private static <U> MemoryModuleType<U> register(String $$0) {
      return (MemoryModuleType<U>)Registry.register(
         BuiltInRegistries.MEMORY_MODULE_TYPE, Identifier.withDefaultNamespace($$0), new MemoryModuleType(Optional.empty())
      );
   }
}
