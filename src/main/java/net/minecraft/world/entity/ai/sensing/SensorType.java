...
public class SensorType<U extends Sensor<?>> {
   ...
   public static final SensorType<NearestLivingEntitySensor<net.minecraft.world.entity.LivingEntity>> NEAREST_LIVING_ENTITIES = register(
   ...
   private static <U extends Sensor<?>> SensorType<U> register(String $$0, Supplier<U> $$1) {
      return (SensorType<U>)Registry.register(BuiltInRegistries.SENSOR_TYPE, Identifier.withDefaultNamespace($$0), new SensorType<>($$1));
   }
}
