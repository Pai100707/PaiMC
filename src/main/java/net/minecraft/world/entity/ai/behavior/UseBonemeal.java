...
public class UseBonemeal extends Behavior<Villager> {
   ...
   protected boolean checkExtraStartConditions(ServerLevel $$0, Villager $$1) {
      if ($$1.tickCount % 10 == 0 && (this.lastBonemealingSession == 0L || this.lastBonemealingSession + 160L <= $$1.tickCount)) {
   ...
   protected void start(ServerLevel $$0, Villager $$1, long $$2) {
      ...
      $$1.setItemSlot(net.minecraft.world.entity.EquipmentSlot.MAINHAND, new ItemStack(Items.BONE_MEAL));
   ...
   protected void stop(ServerLevel $$0, Villager $$1, long $$2) {
      $$1.setItemSlot(net.minecraft.world.entity.EquipmentSlot.MAINHAND, ItemStack.EMPTY);
