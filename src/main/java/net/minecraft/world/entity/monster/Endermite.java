...
public class Endermite extends Monster {
   ...
   public Endermite(net.minecraft.world.entity.EntityType<? extends Endermite> $$0, Level $$1) {
      super($$0, $$1);
      this.xpReward = 3;
   }
   ...
   public static boolean checkEndermiteSpawnRules(
      net.minecraft.world.entity.EntityType<Endermite> $$0, LevelAccessor $$1, net.minecraft.world.entity.EntitySpawnReason $$2, BlockPos $$3, RandomSource $$4
   ) {
