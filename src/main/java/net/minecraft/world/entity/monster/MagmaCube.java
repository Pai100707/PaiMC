...
public class MagmaCube extends Slime {
   public MagmaCube(net.minecraft.world.entity.EntityType<? extends MagmaCube> $$0, Level $$1) {
      super($$0, $$1);
   }
   ...
   public static boolean checkMagmaCubeSpawnRules(
      net.minecraft.world.entity.EntityType<MagmaCube> $$0, LevelAccessor $$1, net.minecraft.world.entity.EntitySpawnReason $$2, BlockPos $$3, RandomSource $$4
   ) {
   ...
   protected void jumpInLiquid(TagKey<Fluid> $$0) {
      if ($$0 == FluidTags.LAVA) {
         ...
         this.setDeltaMovement($$1.x, 0.22F + this.getSize() * 0.05F, $$1.z);
         this.needsSync = true;
      } else {
