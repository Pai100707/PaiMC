...
public class Skeleton extends AbstractSkeleton {
   ...
   public Skeleton(net.minecraft.world.entity.EntityType<? extends Skeleton> $$0, Level $$1) {
      super($$0, $$1);
   }
   ...
   protected void doFreezeConversion() {
      this.convertTo(net.minecraft.world.entity.EntityType.STRAY, net.minecraft.world.entity.ConversionParams.single(this, true, true), $$0 -> {
         if (!this.isSilent()) {
