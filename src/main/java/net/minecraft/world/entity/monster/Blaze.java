...
public class Blaze extends Monster {
   ...
   public Blaze(net.minecraft.world.entity.EntityType<? extends Blaze> $$0, Level $$1) {
      super($$0, $$1);
   ...
   protected void customServerAiStep(ServerLevel $$0) {
      ...
      if ($$1 != null && $$1.getEyeY() > this.getEyeY() + this.allowedHeightOffset && this.canAttack($$1)) {
   ...
   static class BlazeAttackGoal extends Goal {
      ...
      public boolean canUse() {
         net.minecraft.world.entity.LivingEntity $$0 = this.blaze.getTarget();
