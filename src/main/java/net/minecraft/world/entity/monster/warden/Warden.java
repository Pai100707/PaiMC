...
public class Warden extends Monster implements VibrationSystem {
   ...
   public net.minecraft.world.entity.AnimationState sniffAnimationState = new net.minecraft.world.entity.AnimationState();
   public net.minecraft.world.entity.AnimationState emergeAnimationState = new net.minecraft.world.entity.AnimationState();
   public net.minecraft.world.entity.AnimationState diggingAnimationState = new net.minecraft.world.entity.AnimationState();
   public net.minecraft.world.entity.AnimationState attackAnimationState = new net.minecraft.world.entity.AnimationState();
   public net.minecraft.world.entity.AnimationState sonicBoomAnimationState = new net.minecraft.world.entity.AnimationState();
   private final DynamicGameEventListener<Listener> dynamicGameEventListener;
   private final User vibrationUser;
   private Data vibrationData;
   AngerManagement angerManagement = new AngerManagement(this::canTargetEntity, Collections.emptyList());

   public Warden(net.minecraft.world.entity.EntityType<? extends Monster> $$0, Level $$1) {
      super($$0, $$1);
   ...
   public Packet<ClientGamePacketListener> getAddEntityPacket(ServerEntity $$0) {
      return new ClientboundAddEntityPacket(this, $$0, this.hasPose(net.minecraft.world.entity.Pose.EMERGING) ? 1 : 0);
   }
   ...
   public void recreateFromPacket(ClientboundAddEntityPacket $$0) {
      ...
      if ($$0.getData() == 1) {
         this.setPose(net.minecraft.world.entity.Pose.EMERGING);
      }
   }
   ...
   boolean isDiggingOrEmerging() {
      return this.hasPose(net.minecraft.world.entity.Pose.DIGGING) || this.hasPose(net.minecraft.world.entity.Pose.EMERGING);
   }
   ...
   public void tick() {
      if (this.level() instanceof ServerLevel $$0) {
         Ticker.tick($$0, this.vibrationData, this.vibrationUser);
   ...
   private int getHeartBeatDelay() {
      float $$0 = (float)this.getClientAngerLevel() / AngerLevel.ANGRY.getMinimumAnger();
   ...
   private void clientDiggingParticles(net.minecraft.world.entity.AnimationState $$0) {
      if ((float)$$0.getTimeInMillis(this.tickCount) < 4500.0F) {
         ...
         if ($$2.getRenderShape() != RenderShape.INVISIBLE) {
            for (int $$3 = 0; $$3 < 30; $$3++) {
               double $$4 = this.getX() + Mth.randomBetween($$1, -0.7F, 0.7F);
               double $$5 = this.getY();
               double $$6 = this.getZ() + Mth.randomBetween($$1, -0.7F, 0.7F);
   ...
   public boolean canTargetEntity(@Nullable net.minecraft.world.entity.Entity $$0) {
      return $$0 instanceof net.minecraft.world.entity.LivingEntity $$1
         ...
         && !this.isAlliedTo($$0)
         && $$1.getType() != net.minecraft.world.entity.EntityType.ARMOR_STAND
         && $$1.getType() != net.minecraft.world.entity.EntityType.WARDEN
         && !$$1.isInvulnerable()
         && !$$1.isDeadOrDying()
   ...
   protected void readAdditionalSaveData(ValueInput $$0) {
      ...
      this.angerManagement = $$0.read("anger", AngerManagement.codec(this::canTargetEntity))
   ...
   private void playListeningSound() {
      if (!this.hasPose(net.minecraft.world.entity.Pose.ROARING)) {
   ...
   public Optional<net.minecraft.world.entity.LivingEntity> getEntityAngryAt() {
   ...
   public boolean hurtServer(ServerLevel $$0, DamageSource $$1, float $$2) {
      ...
      if (!this.isNoAi() && !this.isDiggingOrEmerging()) {
         ...
         if (this.brain.getMemory(MemoryModuleType.ATTACK_TARGET).isEmpty()
            && $$4 instanceof net.minecraft.world.entity.LivingEntity $$5
   ...
   public net.minecraft.world.entity.EntityDimensions getDefaultDimensions(net.minecraft.world.entity.Pose $$0) {
      net.minecraft.world.entity.EntityDimensions $$1 = super.getDefaultDimensions($$0);
      return this.isDiggingOrEmerging() ? net.minecraft.world.entity.EntityDimensions.fixed($$1.width(), 1.0F) : $$1;
   }
   ...
   class VibrationUser implements User {
      ...
      public boolean canReceiveVibration(ServerLevel $$0, BlockPos $$1, Holder<GameEvent> $$2, Context $$3) {
         return !Warden.this.isNoAi()
            ...
            ? !($$3.sourceEntity() instanceof net.minecraft.world.entity.LivingEntity $$4 && !Warden.this.canTargetEntity($$4))
            : false;
      }
      ...
      public void onReceiveVibration(
         ...
         if (!Warden.this.isDeadOrDying()) {
            ...
            if (!Warden.this.getAngerLevel().isAngry()) {
               Optional<net.minecraft.world.entity.LivingEntity> $$7 = Warden.this.angerManagement.getActiveEntity();
