...
public class Phantom extends net.minecraft.world.entity.Mob implements Enemy {
   ...
   public Phantom(net.minecraft.world.entity.EntityType<? extends Phantom> $$0, Level $$1) {
      super($$0, $$1);
      this.xpReward = 5;
   ...
   public void tick() {
      ...
      if (this.level().isClientSide()) {
         float $$0 = Mth.cos((this.getUniqueFlapTickOffset() + this.tickCount) * 7.448451F * (float) (Math.PI / 180.0) + (float) Math.PI);
         float $$1 = Mth.cos((this.getUniqueFlapTickOffset() + this.tickCount + 1) * 7.448451F * (float) (Math.PI / 180.0) + (float) Math.PI);
         if ($$0 > 0.0F && $$1 <= 0.0F) {
            this.level()
               .playLocalSound(
                  this.getX(),
         ...
         this.level().addParticle(ParticleTypes.MYCELIUM, this.getX() + $$3, this.getY() + $$5, this.getZ() + $$4, 0.0, 0.0, 0.0);
         this.level().addParticle(ParticleTypes.MYCELIUM, this.getX() - $$3, this.getY() + $$5, this.getZ() - $$4, 0.0, 0.0, 0.0);
      }
   }
   ...
   public net.minecraft.world.entity.EntityDimensions getDefaultDimensions(net.minecraft.world.entity.Pose $$0) {
      ...
      net.minecraft.world.entity.EntityDimensions $$2 = super.getDefaultDimensions($$0);
      return $$2.scale(1.0F + 0.15F * $$1);
   }

   boolean canAttack(ServerLevel $$0, net.minecraft.world.entity.LivingEntity $$1, TargetingConditions $$2) {
   ...
   class PhantomAttackPlayerTargetGoal extends Goal {
      ...
      public boolean canUse() {
         if (this.nextScanTick > 0) {
            ...
            if (!$$1.isEmpty()) {
               $$1.sort(Comparator.<Player, Double>comparing(net.minecraft.world.entity.Entity::getY).reversed());
      ...
      public boolean canContinueToUse() {
         net.minecraft.world.entity.LivingEntity $$0 = Phantom.this.getTarget();
      ...
      public void stop() {
         if (Phantom.this.anchorPoint != null) {
            Phantom.this.anchorPoint = Phantom.this.level()
               .getHeightmapPos(Types.MOTION_BLOCKING, Phantom.this.anchorPoint)
   ...
   class PhantomBodyRotationControl extends BodyRotationControl {
      public PhantomBodyRotationControl(final net.minecraft.world.entity.Mob $$0) {
         super($$0);
      }
   ...
   static class PhantomLookControl extends LookControl {
      public PhantomLookControl(net.minecraft.world.entity.Mob $$0) {
         super($$0);
      }
   ...
   class PhantomMoveControl extends MoveControl {
      ...
      public PhantomMoveControl(final net.minecraft.world.entity.Mob $$0) {
         super($$0);
      }
      ...
      public void tick() {
         ...
         if (Math.abs($$3) > 1.0E-5F) {
            ...
            double $$12 = this.speed * Mth.cos($$11 * (float) (Math.PI / 180.0)) * Math.abs($$0 / $$5);
            double $$13 = this.speed * Mth.sin($$11 * (float) (Math.PI / 180.0)) * Math.abs($$2 / $$5);
            double $$14 = this.speed * Mth.sin($$10 * (float) (Math.PI / 180.0)) * Math.abs($$1 / $$5);
   ...
   class PhantomSweepAttackGoal extends Phantom.PhantomMoveTargetGoal {
      ...
      public boolean canContinueToUse() {
         ...
         if ($$0 == null) {
            ...
            return false;
         } else if ($$0 instanceof Player $$1 && ($$0.isSpectator() || $$1.isCreative())) {
            return false;
         } else if (!this.canUse()) {
            return false;
         } else {
            if (Phantom.this.tickCount > this.catSearchTick) {
               ...
               List<Cat> $$2 = Phantom.this.level()
                  .getEntitiesOfClass(Cat.class, Phantom.this.getBoundingBox().inflate(16.0), net.minecraft.world.entity.EntitySelector.ENTITY_STILL_ALIVE);
