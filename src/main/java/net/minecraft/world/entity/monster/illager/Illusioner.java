...
public class Illusioner extends SpellcasterIllager implements RangedAttackMob {
   ...
   public Illusioner(net.minecraft.world.entity.EntityType<? extends Illusioner> $$0, Level $$1) {
      super($$0, $$1);
      this.xpReward = 5;
   ...
   public Vec3[] getIllusionOffsets(float $$0) {
      if (this.clientSideIllusionTicks <= 0) {
         ...
         double $$1 = (this.clientSideIllusionTicks - $$0) / 3.0F;
         $$1 = Math.pow($$1, 0.25);
         Vec3[] $$2 = new Vec3[4];
   ...
   class IllusionerBlindnessSpellGoal extends SpellcasterIllager.SpellcasterUseSpellGoal {
      ...
      public void start() {
         super.start();
         net.minecraft.world.entity.LivingEntity $$0 = Illusioner.this.getTarget();
         if ($$0 != null) {
