...
import net.minecraft.world.item.component.Consumable.OverrideConsumeSound;
...
public class WanderingTrader extends AbstractVillager implements OverrideConsumeSound {
   ...
   public WanderingTrader(net.minecraft.world.entity.EntityType<? extends WanderingTrader> $$0, Level $$1) {
      super($$0, $$1);
   }
   ...
   protected void updateTrades(ServerLevel $$0) {
      ...
      for (Pair<VillagerTrades.ItemListing[], Integer> $$2 : VillagerTrades.WANDERING_TRADER_TRADES) {
         VillagerTrades.ItemListing[] $$3 = (VillagerTrades.ItemListing[])$$2.getLeft();
         this.addOffersFromItemListings($$0, $$1, $$3, (Integer)$$2.getRight());
      }
   }
   ...
   class WanderToPositionGoal extends Goal {
      ...
      WanderToPositionGoal(final WanderingTrader $$0, final double $$1, final double $$2) {
         this.trader = $$0;
         this.stopDistance = $$1;
      ...
      public void tick() {
         ...
         if ($$0 != null && WanderingTrader.this.navigation.isDone()) {
            if (this.isTooFarAway($$0, 10.0)) {
               Vec3 $$1 = new Vec3($$0.getX() - this.trader.getX(), $$0.getY() - this.trader.getY(), $$0.getZ() - this.trader.getZ()).normalize();
