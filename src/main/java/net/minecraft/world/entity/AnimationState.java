...
public class AnimationState {
   ...
   public void ifStarted(Consumer<net.minecraft.world.entity.AnimationState> $$0) {
      if (this.isStarted()) {
         $$0.accept(this);
      }
   }
   ...
   public void fastForward(int $$0, float $$1) {
      if (this.isStarted()) {
         this.startTick -= (int)($$0 * $$1);
      }
   }

   public long getTimeInMillis(float $$0) {
      float $$1 = $$0 - this.startTick;
      return (long)($$1 * 50.0F);
   }
   ...
   public void copyFrom(net.minecraft.world.entity.AnimationState $$0) {
