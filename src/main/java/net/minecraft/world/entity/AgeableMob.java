...
public abstract class AgeableMob extends net.minecraft.world.entity.PathfinderMob {
   private static final EntityDataAccessor<Boolean> DATA_BABY_ID = SynchedEntityData.defineId(
      net.minecraft.world.entity.AgeableMob.class, EntityDataSerializers.BOOLEAN
   );
   ...
   protected AgeableMob(net.minecraft.world.entity.EntityType<? extends net.minecraft.world.entity.AgeableMob> $$0, Level $$1) {
      super($$0, $$1);
   }
   ...
   public net.minecraft.world.entity.SpawnGroupData finalizeSpawn(
      ...
      net.minecraft.world.entity.AgeableMob.AgeableMobGroupData $$4 = (net.minecraft.world.entity.AgeableMob.AgeableMobGroupData)$$3;
   ...
   protected void ageBoundaryReached() {
      if (!this.isBaby() && this.isPassenger() && this.getVehicle() instanceof AbstractBoat $$0 && !$$0.hasEnoughSpaceFor(this)) {
         this.stopRiding();
      }
   }
   ...
   public static class AgeableMobGroupData implements net.minecraft.world.entity.SpawnGroupData {
