...
public final class BitSetDiscreteVoxelShape extends DiscreteVoxelShape {
   ...
   public BitSetDiscreteVoxelShape(DiscreteVoxelShape $$0) {
      ...
      this.xMin = $$0.firstFull(Axis.X);
      this.yMin = $$0.firstFull(Axis.Y);
      this.zMin = $$0.firstFull(Axis.Z);
      this.xMax = $$0.lastFull(Axis.X);
      this.yMax = $$0.lastFull(Axis.Y);
      this.zMax = $$0.lastFull(Axis.Z);
   }
   ...
   @Override
   public int firstFull(Axis $$0) {
      return $$0.choose(this.xMin, this.yMin, this.zMin);
   }

   @Override
   public int lastFull(Axis $$0) {
   ...
   private boolean isZStripFull(int $$0, int $$1, int $$2, int $$3) {
      return $$2 < this.xSize && $$3 < this.ySize ? this.storage.nextClearBit(this.getIndex($$2, $$3, $$0)) >= this.getIndex($$2, $$3, $$1) : false;
   }
