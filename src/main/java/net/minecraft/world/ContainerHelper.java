...
public class ContainerHelper {
   ...
   public static ItemStack removeItem(List<ItemStack> $$0, int $$1, int $$2) {
      return $$1 >= 0 && $$1 < $$0.size() && !$$0.get($$1).isEmpty() && $$2 > 0 ? $$0.get($$1).split($$2) : ItemStack.EMPTY;
   }

   public static ItemStack takeItem(List<ItemStack> $$0, int $$1) {
      return $$1 >= 0 && $$1 < $$0.size() ? $$0.set($$1, ItemStack.EMPTY) : ItemStack.EMPTY;
   }
   ...
   public static void saveAllItems(ValueOutput $$0, NonNullList<ItemStack> $$1, boolean $$2) {
      TypedOutputList<ItemStackWithSlot> $$3 = $$0.list("Items", ItemStackWithSlot.CODEC);

      for (int $$4 = 0; $$4 < $$1.size(); $$4++) {
         ItemStack $$5 = (ItemStack)$$1.get($$4);
         if (!$$5.isEmpty()) {
