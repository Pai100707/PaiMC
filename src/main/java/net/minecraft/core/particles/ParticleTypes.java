...
public class ParticleTypes {
   ...
   private static SimpleParticleType register(String $$0, boolean $$1) {
      return net.minecraft.core.Registry.register(BuiltInRegistries.PARTICLE_TYPE, $$0, new SimpleParticleType($$1));
   }
   ...
   private static <T extends ParticleOptions> ParticleType<T> register(
      ...
      return net.minecraft.core.Registry.register(BuiltInRegistries.PARTICLE_TYPE, $$0, new ParticleType<T>($$1) {
         @Override
