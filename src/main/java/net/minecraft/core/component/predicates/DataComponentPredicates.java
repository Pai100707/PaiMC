...
public class DataComponentPredicates {
   ...
   private static <T extends DataComponentPredicate> DataComponentPredicate.Type<T> register(String $$0, Codec<T> $$1) {
      return net.minecraft.core.Registry.register(BuiltInRegistries.DATA_COMPONENT_PREDICATE_TYPE, $$0, new DataComponentPredicate.ConcreteType<>($$1));
   }

   public static DataComponentPredicate.Type<?> bootstrap(net.minecraft.core.Registry<DataComponentPredicate.Type<?>> $$0) {
      return DAMAGE;
   }
}
