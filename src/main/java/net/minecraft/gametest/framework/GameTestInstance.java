...
public abstract class GameTestInstance {
   ...
   private static MapCodec<? extends GameTestInstance> register(
      ...
      return (MapCodec<? extends GameTestInstance>)Registry.register(
         $$0, ResourceKey.create(Registries.TEST_INSTANCE_TYPE, Identifier.withDefaultNamespace($$1)), $$2
      );
   }
   ...
   protected MutableComponent descriptionRow(String $$0, MutableComponent $$1) {
      return Component.translatable($$0, new Object[]{$$1.withStyle(ChatFormatting.BLUE)}).append(Component.literal("\n"));
   }
}
