...
public class BlankFormat implements NumberFormat {
   ...
   public static final NumberFormatType<BlankFormat> TYPE = new NumberFormatType<BlankFormat>() {
      ...
      private static final StreamCodec<net.minecraft.network.RegistryFriendlyByteBuf, BlankFormat> STREAM_CODEC = StreamCodec.unit(BlankFormat.INSTANCE);
      ...
      @Override
      public StreamCodec<net.minecraft.network.RegistryFriendlyByteBuf, BlankFormat> streamCodec() {
         return STREAM_CODEC;
      }
   };
