...
public record FixedFormat(Component value) implements NumberFormat {
   public static final NumberFormatType<FixedFormat> TYPE = new NumberFormatType<FixedFormat>() {
      ...
      private static final StreamCodec<net.minecraft.network.RegistryFriendlyByteBuf, FixedFormat> STREAM_CODEC = StreamCodec.composite(
      ...
      @Override
      public StreamCodec<net.minecraft.network.RegistryFriendlyByteBuf, FixedFormat> streamCodec() {
         return STREAM_CODEC;
      }
   };
