...
public record StyledFormat(Style style) implements NumberFormat {
   public static final NumberFormatType<StyledFormat> TYPE = new NumberFormatType<StyledFormat>() {
      ...
      private static final StreamCodec<net.minecraft.network.RegistryFriendlyByteBuf, StyledFormat> STREAM_CODEC = StreamCodec.composite(
      ...
      @Override
      public StreamCodec<net.minecraft.network.RegistryFriendlyByteBuf, StyledFormat> streamCodec() {
         return STREAM_CODEC;
      }
   };
