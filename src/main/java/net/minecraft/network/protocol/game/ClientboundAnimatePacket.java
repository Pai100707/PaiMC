...
public class ClientboundAnimatePacket implements Packet<ClientGamePacketListener> {
   public static final StreamCodec<net.minecraft.network.FriendlyByteBuf, ClientboundAnimatePacket> STREAM_CODEC = Packet.codec(
   ...
   private ClientboundAnimatePacket(net.minecraft.network.FriendlyByteBuf $$0) {
