...
public class GameProtocols {
   public static final CodecModifier<net.minecraft.network.RegistryFriendlyByteBuf, ServerboundSetCreativeModeSlotPacket, GameProtocols.Context> HAS_INFINITE_MATERIALS = ($$0, $$1) -> new StreamCodec<net.minecraft.network.RegistryFriendlyByteBuf, ServerboundSetCreativeModeSlotPacket>(
      
   ) {
      public ServerboundSetCreativeModeSlotPacket decode(net.minecraft.network.RegistryFriendlyByteBuf $$0x) {
         if (!$$1.hasInfiniteMaterials()) {
            throw new net.minecraft.network.SkipPacketDecoderException("Not in creative mode");
         } else {
            return (ServerboundSetCreativeModeSlotPacket)$$0.decode($$0);
         }
      }

      public void encode(net.minecraft.network.RegistryFriendlyByteBuf $$0x, ServerboundSetCreativeModeSlotPacket $$1x) {
         if (!$$1.hasInfiniteMaterials()) {
            throw new net.minecraft.network.SkipPacketEncoderException("Not in creative mode");
         } else {
            $$0.encode($$0, $$1);
         }
      }
   };
   public static final UnboundProtocol<ServerGamePacketListener, net.minecraft.network.RegistryFriendlyByteBuf, GameProtocols.Context> SERVERBOUND_TEMPLATE = ProtocolInfoBuilder.contextServerboundProtocol(
   ...
   public static final SimpleUnboundProtocol<ClientGamePacketListener, net.minecraft.network.RegistryFriendlyByteBuf> CLIENTBOUND_TEMPLATE = ProtocolInfoBuilder.clientboundProtocol(
      net.minecraft.network.ConnectionProtocol.PLAY,
