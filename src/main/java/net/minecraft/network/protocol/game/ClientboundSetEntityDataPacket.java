...
public record ClientboundSetEntityDataPacket(int id, List<SynchedEntityData.DataValue<?>> packedItems) implements Packet<ClientGamePacketListener> {
   public static final StreamCodec<net.minecraft.network.RegistryFriendlyByteBuf, ClientboundSetEntityDataPacket> STREAM_CODEC = Packet.codec(
      ClientboundSetEntityDataPacket::write, ClientboundSetEntityDataPacket::new
   );
   public static final int EOF_MARKER = 255;

   private ClientboundSetEntityDataPacket(net.minecraft.network.RegistryFriendlyByteBuf $$0) {
      this($$0.readVarInt(), unpack($$0));
   }

   private static void pack(List<SynchedEntityData.DataValue<?>> $$0, net.minecraft.network.RegistryFriendlyByteBuf $$1) {
   ...
   private static List<SynchedEntityData.DataValue<?>> unpack(net.minecraft.network.RegistryFriendlyByteBuf $$0) {
