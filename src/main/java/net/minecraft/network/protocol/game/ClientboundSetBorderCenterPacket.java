...
public class ClientboundSetBorderCenterPacket implements Packet<ClientGamePacketListener> {
   public static final StreamCodec<net.minecraft.network.FriendlyByteBuf, ClientboundSetBorderCenterPacket> STREAM_CODEC = Packet.codec(
   ...
   private ClientboundSetBorderCenterPacket(net.minecraft.network.FriendlyByteBuf $$0) {
