...
public class ClientboundPlayerAbilitiesPacket implements Packet<ClientGamePacketListener> {
   public static final StreamCodec<net.minecraft.network.FriendlyByteBuf, ClientboundPlayerAbilitiesPacket> STREAM_CODEC = Packet.codec(
   ...
   private ClientboundPlayerAbilitiesPacket(net.minecraft.network.FriendlyByteBuf $$0) {
      byte $$1 = $$0.readByte();
