...
public class ClientboundContainerSetSlotPacket implements Packet<ClientGamePacketListener> {
   public static final StreamCodec<net.minecraft.network.RegistryFriendlyByteBuf, ClientboundContainerSetSlotPacket> STREAM_CODEC = Packet.codec(
   ...
   private ClientboundContainerSetSlotPacket(net.minecraft.network.RegistryFriendlyByteBuf $$0) {
