...
public class ClientboundMountScreenOpenPacket implements Packet<ClientGamePacketListener> {
   public static final StreamCodec<net.minecraft.network.FriendlyByteBuf, ClientboundMountScreenOpenPacket> STREAM_CODEC = Packet.codec(
   ...
   private ClientboundMountScreenOpenPacket(net.minecraft.network.FriendlyByteBuf $$0) {
