...
public class ClientboundUpdateMobEffectPacket implements Packet<ClientGamePacketListener> {
   public static final StreamCodec<net.minecraft.network.RegistryFriendlyByteBuf, ClientboundUpdateMobEffectPacket> STREAM_CODEC = Packet.codec(
   ...
   private ClientboundUpdateMobEffectPacket(net.minecraft.network.RegistryFriendlyByteBuf $$0) {
      this.entityId = $$0.readVarInt();
      this.effect = (Holder<MobEffect>)MobEffect.STREAM_CODEC.decode($$0);
