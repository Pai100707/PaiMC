...
public record ServerboundContainerClickPacket(
   ...
   byte buttonNum,
   ClickType clickType,
   Int2ObjectMap<net.minecraft.network.HashedStack> changedSlots,
   net.minecraft.network.HashedStack carriedItem
) implements Packet<ServerGamePacketListener> {
   private static final int MAX_SLOT_COUNT = 128;
   private static final StreamCodec<net.minecraft.network.RegistryFriendlyByteBuf, Int2ObjectMap<net.minecraft.network.HashedStack>> SLOTS_STREAM_CODEC = ByteBufCodecs.map(
      Int2ObjectOpenHashMap::new, ByteBufCodecs.SHORT.map(Short::intValue, Integer::shortValue), net.minecraft.network.HashedStack.STREAM_CODEC, 128
   );
   public static final StreamCodec<net.minecraft.network.RegistryFriendlyByteBuf, ServerboundContainerClickPacket> STREAM_CODEC = StreamCodec.composite(
