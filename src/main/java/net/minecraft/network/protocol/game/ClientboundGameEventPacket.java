...
public class ClientboundGameEventPacket implements Packet<ClientGamePacketListener> {
   public static final StreamCodec<net.minecraft.network.FriendlyByteBuf, ClientboundGameEventPacket> STREAM_CODEC = Packet.codec(
   ...
   private ClientboundGameEventPacket(net.minecraft.network.FriendlyByteBuf $$0) {
      this.event = (ClientboundGameEventPacket.Type)ClientboundGameEventPacket.Type.TYPES.get($$0.readUnsignedByte());
