...
public class ClientboundHelloPacket implements Packet<ClientLoginPacketListener> {
   public static final StreamCodec<net.minecraft.network.FriendlyByteBuf, ClientboundHelloPacket> STREAM_CODEC = Packet.codec(
   ...
   private ClientboundHelloPacket(net.minecraft.network.FriendlyByteBuf $$0) {
