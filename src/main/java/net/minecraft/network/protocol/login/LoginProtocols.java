...
public class LoginProtocols {
   public static final SimpleUnboundProtocol<ServerLoginPacketListener, net.minecraft.network.FriendlyByteBuf> SERVERBOUND_TEMPLATE = ProtocolInfoBuilder.serverboundProtocol(
   ...
   public static final net.minecraft.network.ProtocolInfo<ServerLoginPacketListener> SERVERBOUND = SERVERBOUND_TEMPLATE.bind(
      net.minecraft.network.FriendlyByteBuf::new
   );
   public static final SimpleUnboundProtocol<ClientLoginPacketListener, net.minecraft.network.FriendlyByteBuf> CLIENTBOUND_TEMPLATE = ProtocolInfoBuilder.clientboundProtocol(
      net.minecraft.network.ConnectionProtocol.LOGIN,
   ...
   public static final net.minecraft.network.ProtocolInfo<ClientLoginPacketListener> CLIENTBOUND = CLIENTBOUND_TEMPLATE.bind(
      net.minecraft.network.FriendlyByteBuf::new
   );
}
