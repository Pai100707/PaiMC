...
public record ClientboundRegistryDataPacket(ResourceKey<? extends Registry<?>> registry, List<PackedRegistryEntry> entries)
   ...
   public static final StreamCodec<net.minecraft.network.FriendlyByteBuf, ClientboundRegistryDataPacket> STREAM_CODEC = StreamCodec.composite(
      REGISTRY_KEY_STREAM_CODEC,
      ClientboundRegistryDataPacket::registry,
      PackedRegistryEntry.STREAM_CODEC.apply(ByteBufCodecs.list()),
