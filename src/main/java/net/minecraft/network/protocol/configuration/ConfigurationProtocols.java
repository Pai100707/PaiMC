...
public class ConfigurationProtocols {
   public static final SimpleUnboundProtocol<ServerConfigurationPacketListener, net.minecraft.network.FriendlyByteBuf> SERVERBOUND_TEMPLATE = ProtocolInfoBuilder.serverboundProtocol(
   ...
   public static final net.minecraft.network.ProtocolInfo<ServerConfigurationPacketListener> SERVERBOUND = SERVERBOUND_TEMPLATE.bind(
      net.minecraft.network.FriendlyByteBuf::new
   );
   public static final SimpleUnboundProtocol<ClientConfigurationPacketListener, net.minecraft.network.FriendlyByteBuf> CLIENTBOUND_TEMPLATE = ProtocolInfoBuilder.clientboundProtocol(
      net.minecraft.network.ConnectionProtocol.CONFIGURATION,
   ...
   public static final net.minecraft.network.ProtocolInfo<ClientConfigurationPacketListener> CLIENTBOUND = CLIENTBOUND_TEMPLATE.bind(
      net.minecraft.network.FriendlyByteBuf::new
   );
}
