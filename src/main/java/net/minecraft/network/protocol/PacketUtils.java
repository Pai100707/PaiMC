...
public class PacketUtils {
   ...
   public static <T extends net.minecraft.network.PacketListener> void ensureRunningOnSameThread(Packet<T> $$0, T $$1, ServerLevel $$2) throws RunningOnDifferentThreadException {
      ensureRunningOnSameThread($$0, $$1, $$2.getServer().packetProcessor());
   }

   public static <T extends net.minecraft.network.PacketListener> void ensureRunningOnSameThread(
      Packet<T> $$0, T $$1, net.minecraft.network.PacketProcessor $$2
   ...
   public static <T extends net.minecraft.network.PacketListener> ReportedException makeReportedException(Exception $$0, Packet<T> $$1, T $$2) {
