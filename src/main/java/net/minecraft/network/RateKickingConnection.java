...
public class RateKickingConnection extends net.minecraft.network.Connection {
   ...
   protected void tickSecond() {
      ...
      if ($$0 > this.rateLimitPacketsPerSecond) {
         LOGGER.warn("Player exceeded rate-limit (sent {} packets per second)", $$0);
         this.send(new ClientboundDisconnectPacket(EXCEED_REASON), net.minecraft.network.PacketSendListener.thenRun(() -> this.disconnect(EXCEED_REASON)));
         this.setReadOnly();
      }
   }
}
