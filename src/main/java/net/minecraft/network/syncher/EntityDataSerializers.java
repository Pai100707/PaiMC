...
public class EntityDataSerializers {
   ...
   public static final EntityDataSerializer<ItemStack> ITEM_STACK = new EntityDataSerializer<ItemStack>() {
      @Override
      public StreamCodec<? super net.minecraft.network.RegistryFriendlyByteBuf, ItemStack> codec() {
   ...
   private static final StreamCodec<ByteBuf, Optional<BlockState>> OPTIONAL_BLOCK_STATE_CODEC = new StreamCodec<ByteBuf, Optional<BlockState>>() {
      public void encode(ByteBuf $$0, Optional<BlockState> $$1) {
         if ($$1.isPresent()) {
            net.minecraft.network.VarInt.write($$0, Block.getId($$1.get()));
         } else {
   ...
   private static final StreamCodec<ByteBuf, OptionalInt> OPTIONAL_UNSIGNED_INT_CODEC = new StreamCodec<ByteBuf, OptionalInt>() {
      ...
      public void encode(ByteBuf $$0, OptionalInt $$1) {
         net.minecraft.network.VarInt.write($$0, $$1.orElse(-1) + 1);
      }
   };
   ...
   public static final EntityDataSerializer<ArmadilloState> ARMADILLO_STATE = EntityDataSerializer.forValueType(ArmadilloState.STREAM_CODEC);
   public static final EntityDataSerializer<State> SNIFFER_STATE = EntityDataSerializer.forValueType(State.STREAM_CODEC);
   public static final EntityDataSerializer<WeatherState> WEATHERING_COPPER_STATE = EntityDataSerializer.forValueType(WeatherState.STREAM_CODEC);
