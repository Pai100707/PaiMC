...
public class GameRuleRegistryFix extends DataFix {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         $$0 -> $$0.update(
            ...
            $$0x -> $$0x.renameAndFixField(
               ...
               "game_rules",
               $$0xx -> {
                  boolean $$1 = Boolean.parseBoolean($$0xx.get("doFireTick").asString("true"));
                  boolean $$2 = Boolean.parseBoolean($$0xx.get("allowFireTicksAwayFromPlayer").asString("false"));
                  int $$3;
                  if (!$$1) {
                     $$3 = 0;
                  } else if (!$$2) {
                  ...
                  if ($$3 != 128) {
                     $$0xx = $$0xx.set("minecraft:fire_spread_radius_around_player", $$0xx.createInt($$3));
                  }

                  return $$0xx.remove("spawnChunkRadius")
                     ...
                     .renameAndFixField("commandModificationBlockLimit", "minecraft:max_block_modifications", $$0xxx -> convertInteger($$0xxx, 1))
                     ...
                     .renameAndFixField("maxCommandChainLength", "minecraft:max_command_sequence_length", $$0xxx -> convertInteger($$0xxx, 0))
                     .renameAndFixField("maxCommandForkCount", "minecraft:max_command_forks", $$0xxx -> convertInteger($$0xxx, 0))
                     .renameAndFixField("maxEntityCramming", "minecraft:max_entity_cramming", $$0xxx -> convertInteger($$0xxx, 0))
                     ...
                     .renameAndFixField(
                        "playersNetherPortalCreativeDelay", "minecraft:players_nether_portal_creative_delay", $$0xxx -> convertInteger($$0xxx, 0)
                     )
                     .renameAndFixField("playersNetherPortalDefaultDelay", "minecraft:players_nether_portal_default_delay", $$0xxx -> convertInteger($$0xxx, 0))
                     .renameAndFixField("playersSleepingPercentage", "minecraft:players_sleeping_percentage", $$0xxx -> convertInteger($$0xxx, 0))
                     ...
                     .renameAndFixField("randomTickSpeed", "minecraft:random_tick_speed", $$0xxx -> convertInteger($$0xxx, 0))
                     ...
                     .renameAndFixField("snowAccumulationHeight", "minecraft:max_snow_accumulation_height", $$0xxx -> convertInteger($$0xxx, 0, 8))
   ...
   private static Dynamic<?> convertInteger(Dynamic<?> $$0) {
      return convertInteger($$0, Integer.MIN_VALUE, Integer.MAX_VALUE);
   }
   ...
   private static Dynamic<?> convertInteger(Dynamic<?> $$0, int $$1, int $$2) {
      ...
      try {
         ...
         return $$0.createInt(net.minecraft.util.Mth.clamp($$4, $$1, $$2));
