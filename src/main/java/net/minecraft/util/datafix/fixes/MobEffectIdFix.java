...
public class MobEffectIdFix extends DataFix {
   private static final Int2ObjectMap<String> ID_MAP = net.minecraft.util.Util.make(new Int2ObjectOpenHashMap(), $$0 -> {
            ...
            if ($$3.isPresent()) {
               ...
               if (MOB_EFFECT_INSTANCE_CARRIER_ITEMS.contains($$4)) {
                  return $$2x.updateTyped(
                     $$2,
                     $$0xx -> $$0xx.update(DSL.remainderFinder(), $$0xxx -> updateMobEffectInstanceList($$0xxx, "CustomPotionEffects", "custom_potion_effects"))
                  );
               }
            }
