...
public class ItemIdFix extends DataFix {
   private static final Int2ObjectMap<String> ITEM_NAMES = (Int2ObjectMap<String>)DataFixUtils.make(new Int2ObjectOpenHashMap(), $$0 -> {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         $$2x -> $$2x.update($$2, $$1, $$0xx -> (Pair)$$0xx.map($$0xxx -> Pair.of(References.ITEM_NAME.typeName(), getItem($$0xxx)), $$0xxx -> $$0xxx))
      );
   }
}
