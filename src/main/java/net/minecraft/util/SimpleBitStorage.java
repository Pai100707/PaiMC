...
public class SimpleBitStorage implements net.minecraft.util.BitStorage {
      ...
      if ($$2 != null) {
         if ($$2.length != $$4) {
            throw new net.minecraft.util.SimpleBitStorage.InitializationException(
               "Invalid length given for storage, got: " + $$2.length + " but expected: " + $$4
            );
         }
   ...
   private int cellIndex(int $$0) {
      ...
      return (int)($$0 * $$1 + $$2 >> 32 >> this.divideShift);
   }
   ...
   public int getAndSet(int $$0, int $$1) {
      ...
      this.data[$$2] = $$3 & ~(this.mask << $$4) | ($$1 & this.mask) << $$4;
      return $$5;
   }
   ...
   public net.minecraft.util.BitStorage copy() {
      return new net.minecraft.util.SimpleBitStorage(this.bits, this.size, (long[])this.data.clone());
   }
