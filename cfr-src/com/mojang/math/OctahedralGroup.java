...
public enum OctahedralGroup implements StringRepresentable
{
    ...
    static {
        ...
        CAYLEY_TABLE = Util.make(() -> {
            OctahedralGroup[] $$02 = OctahedralGroup.values();
            OctahedralGroup[][] $$1 = new OctahedralGroup[$$02.length][$$02.length];
            Map<Integer, OctahedralGroup> $$2 = Arrays.stream($$02).collect(Collectors.toMap(OctahedralGroup::trace, $$0 -> $$0));
            for (OctahedralGroup $$3 : $$02) {
                for (OctahedralGroup $$4 : $$02) {
                    ...
                    $$1[$$3.ordinal()][$$4.ordinal()] = $$2.get(OctahedralGroup.trace($$6, $$7, $$8, $$5));
                }
            }
            return $$1;
        });
