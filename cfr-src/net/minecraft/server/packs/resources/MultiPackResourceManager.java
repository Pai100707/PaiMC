...
implements CloseableResourceManager {
    ...
    public MultiPackResourceManager(PackType $$0, List<PackResources> $$12) {
        ...
        for (PackResources $$4 : $$12) {
            ...
            Predicate<Identifier> $$7 = $$5 != null ? $$1 -> $$5.isPathFiltered($$1.getPath()) : null;
            for (String $$8 : $$3) {
                boolean $$10;
    ...
    private @Nullable ResourceFilterSection getPackFilterSection(PackResources $$0) {
        try {
    ...
    public Map<Identifier, Resource> listResources(String $$0, Predicate<Identifier> $$1) {
        ...
        TreeMap<Identifier, Resource> $$2 = new TreeMap<Identifier, Resource>();
    ...
    public Map<Identifier, List<Resource>> listResourceStacks(String $$0, Predicate<Identifier> $$1) {
        MultiPackResourceManager.checkTrailingDirectoryPath($$0);
        TreeMap<Identifier, List<Resource>> $$2 = new TreeMap<Identifier, List<Resource>>();
        for (FallbackResourceManager $$3 : this.namespacedManagers.values()) {
