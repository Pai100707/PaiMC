...
public class GiveCommand {
    ...
    private static int giveItem(CommandSourceStack $$0, ItemInput $$1, Collection<ServerPlayer> $$2, int $$3) throws CommandSyntaxException {
        ...
        if ($$2.size() == 1) {
            $$0.sendSuccess(() -> Component.translatable("commands.give.success.single", $$3, $$4.getDisplayName(), ((ServerPlayer)$$2.iterator().next()).getDisplayName()), true);
        } else {
