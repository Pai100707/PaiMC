...
public interface PermissionCheck {
    public static final Codec<PermissionCheck> CODEC = BuiltInRegistries.PERMISSION_CHECK_TYPE.byNameCodec().dispatch(PermissionCheck::codec, $$0 -> $$0);
    ...
    {
        public static final MapCodec<Require> MAP_CODEC = RecordCodecBuilder.mapCodec($$0 -> $$0.group((App)Permission.CODEC.fieldOf("permission").forGetter(Require::permission)).apply((Applicative)$$0, Require::new));
