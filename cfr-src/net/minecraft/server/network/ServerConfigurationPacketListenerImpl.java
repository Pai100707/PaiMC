...
TickablePacketListener {
    ...
    public void startConfiguration() {
        ...
        List<KnownPack> $$2 = this.server.getResourceManager().listPacks().flatMap($$0 -> $$0.location().knownPackInfo().stream()).toList();
    ...
    private void addOptionalTasks() {
        Map<String, String> $$02 = this.server.getCodeOfConducts();
        if (!$$02.isEmpty()) {
            this.configurationTasks.add(new ServerCodeOfConductConfigurationTask(() -> {
                String $$1 = (String)$$02.get(this.clientInformation.language().toLowerCase(Locale.ROOT));
                if ($$1 == null) {
        ...
        this.server.getServerResourcePack().ifPresent($$0 -> this.configurationTasks.add(new ServerResourcePackConfigurationTask((MinecraftServer.ServerResourcePackInfo)$$0)));
    }
    ...
    public void tick() {
        ...
        if ($$0 != null) {
            try {
                ...
                LOGGER.error("Failed to tick configuration task {}", (Object)$$0.type(), (Object)$$1);
    ...
    private void startNextTask() {
        ...
        if ($$0 != null) {
            ...
            try {
                ...
                LOGGER.error("Failed to start configuration task {}", (Object)$$0.type(), (Object)$$1);
                this.disconnect(DISCONNECT_REASON_CONFIGURATION_ERROR);
            }
        }
    }
