...
implements Enemy {
    ...
    public static boolean checkMonsterSpawnRules(EntityType<? extends Mob> $$0, ServerLevelAccessor $$1, EntitySpawnReason $$2, BlockPos $$3, RandomSource $$4) {
    ...
    public static boolean checkSurfaceMonstersSpawnRules(EntityType<? extends Mob> $$0, ServerLevelAccessor $$1, EntitySpawnReason $$2, BlockPos $$3, RandomSource $$4) {
        return Monster.checkMonsterSpawnRules($$0, $$1, $$2, $$3, $$4) && (EntitySpawnReason.isSpawner($$2) || $$1.canSeeSky($$3));
    }
    ...
    protected boolean shouldDropLoot(ServerLevel $$0) {
        return $$0.getGameRules().get(GameRules.MOB_DROPS);
    }
