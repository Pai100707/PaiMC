...
{
    public static final Codec<ZombieNautilusVariant> DIRECT_CODEC = RecordCodecBuilder.create($$0 -> $$0.group((App)ModelAndTexture.codec(ModelType.CODEC, ModelType.NORMAL).forGetter(ZombieNautilusVariant::modelAndTexture), (App)SpawnPrioritySelectors.CODEC.fieldOf("spawn_conditions").forGetter(ZombieNautilusVariant::spawnConditions)).apply((Applicative)$$0, ZombieNautilusVariant::new));
    public static final Codec<ZombieNautilusVariant> NETWORK_CODEC = RecordCodecBuilder.create($$0 -> $$0.group((App)ModelAndTexture.codec(ModelType.CODEC, ModelType.NORMAL).forGetter(ZombieNautilusVariant::modelAndTexture)).apply((Applicative)$$0, ZombieNautilusVariant::new));
    ...
    private ZombieNautilusVariant(ModelAndTexture<ModelType> $$0) {
