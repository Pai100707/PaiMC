    ...
    public void doClientTick() {
        ...
        if (this.flameTicks % 2 == 0 && this.flameTicks < 10) {
            ...
            for (int $$4 = 0; $$4 < 8; ++$$4) {
                ...
                for (int $$8 = 0; $$8 < 6; ++$$8) {
                    this.dragon.level().addParticle(PowerParticleOption.create(ParticleTypes.DRAGON_BREATH, 1.0f), $$5, $$6, $$7, -$$0.x * (double)0.08f * (double)$$8, -$$0.y * (double)0.6f, -$$0.z * (double)0.08f * (double)$$8);
                }
                $$0.yRot(0.19634955f);
            }
        }
