...
extends AbstractDragonPhaseInstance {
    ...
    public void doClientTick() {
        ...
        for (int $$4 = 0; $$4 < 8; ++$$4) {
            ...
            this.dragon.level().addParticle(PowerParticleOption.create(ParticleTypes.DRAGON_BREATH, 1.0f), $$6, $$7, $$8, -$$0.x * (double)0.08f + $$9.x, -$$0.y * (double)0.3f + $$9.y, -$$0.z * (double)0.08f + $$9.z);
            $$0.yRot(0.19634955f);
        }
    }
