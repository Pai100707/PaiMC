...
public class DataComponents {
    ...
    public static final DataComponentType<Integer> DAMAGE = DataComponents.register("damage", $$0 -> $$0.persistent(ExtraCodecs.NON_NEGATIVE_INT).ignoreSwapAnimation().networkSynchronized(ByteBufCodecs.VAR_INT));
    ...
    public static final DataComponentType<UseEffects> USE_EFFECTS = DataComponents.register("use_effects", $$0 -> $$0.persistent(UseEffects.CODEC).networkSynchronized(UseEffects.STREAM_CODEC));
    ...
    public static final DataComponentType<Float> MINIMUM_ATTACK_CHARGE = DataComponents.register("minimum_attack_charge", $$0 -> $$0.persistent(ExtraCodecs.floatRange(0.0f, 1.0f)).networkSynchronized(ByteBufCodecs.FLOAT));
    public static final DataComponentType<EitherHolder<DamageType>> DAMAGE_TYPE = DataComponents.register("damage_type", $$0 -> $$0.persistent(EitherHolder.codec(Registries.DAMAGE_TYPE, DamageType.CODEC)).networkSynchronized(EitherHolder.streamCodec(Registries.DAMAGE_TYPE, DamageType.STREAM_CODEC)));
    ...
    public static final DataComponentType<Identifier> ITEM_MODEL = DataComponents.register("item_model", $$0 -> $$0.persistent(Identifier.CODEC).networkSynchronized(Identifier.STREAM_CODEC).cacheEncoding());
    ...
    public static final DataComponentType<AttackRange> ATTACK_RANGE = DataComponents.register("attack_range", $$0 -> $$0.persistent(AttackRange.CODEC).networkSynchronized(AttackRange.STREAM_CODEC).cacheEncoding());
    ...
    public static final DataComponentType<Identifier> TOOLTIP_STYLE = DataComponents.register("tooltip_style", $$0 -> $$0.persistent(Identifier.CODEC).networkSynchronized(Identifier.STREAM_CODEC).cacheEncoding());
    ...
    public static final DataComponentType<PiercingWeapon> PIERCING_WEAPON = DataComponents.register("piercing_weapon", $$0 -> $$0.persistent(PiercingWeapon.CODEC).networkSynchronized(PiercingWeapon.STREAM_CODEC).cacheEncoding());
    public static final DataComponentType<KineticWeapon> KINETIC_WEAPON = DataComponents.register("kinetic_weapon", $$0 -> $$0.persistent(KineticWeapon.CODEC).networkSynchronized(KineticWeapon.STREAM_CODEC).cacheEncoding());
    public static final DataComponentType<SwingAnimation> SWING_ANIMATION = DataComponents.register("swing_animation", $$0 -> $$0.persistent(SwingAnimation.CODEC).networkSynchronized(SwingAnimation.STREAM_CODEC));
    ...
    public static final DataComponentType<TypedEntityData<EntityType<?>>> ENTITY_DATA = DataComponents.register("entity_data", $$0 -> $$0.persistent(TypedEntityData.codec(EntityType.CODEC)).networkSynchronized(TypedEntityData.streamCodec(EntityType.STREAM_CODEC)));
    ...
    public static final DataComponentType<TypedEntityData<BlockEntityType<?>>> BLOCK_ENTITY_DATA = DataComponents.register("block_entity_data", $$0 -> $$0.persistent(TypedEntityData.codec(BuiltInRegistries.BLOCK_ENTITY_TYPE.byNameCodec())).networkSynchronized(TypedEntityData.streamCodec(ByteBufCodecs.registry(Registries.BLOCK_ENTITY_TYPE))));
    ...
    public static final DataComponentType<Identifier> NOTE_BLOCK_SOUND = DataComponents.register("note_block_sound", $$0 -> $$0.persistent(Identifier.CODEC).networkSynchronized(Identifier.STREAM_CODEC));
    ...
    public static final DataComponentType<EitherHolder<ZombieNautilusVariant>> ZOMBIE_NAUTILUS_VARIANT = DataComponents.register("zombie_nautilus/variant", $$0 -> $$0.persistent(EitherHolder.codec(Registries.ZOMBIE_NAUTILUS_VARIANT, ZombieNautilusVariant.CODEC)).networkSynchronized(EitherHolder.streamCodec(Registries.ZOMBIE_NAUTILUS_VARIANT, ZombieNautilusVariant.STREAM_CODEC)));
