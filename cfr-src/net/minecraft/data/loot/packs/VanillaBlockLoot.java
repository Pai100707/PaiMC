...
extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        Blocks.COPPER_BARS.forEach($$1 -> this.dropSelf((Block)$$1));
        ...
        Blocks.COPPER_CHAIN.forEach($$1 -> this.dropSelf((Block)$$1));
        ...
        this.add(Blocks.COPPER_GOLEM_STATUE, (Block $$1) -> this.createCopperGolemStatueBlock((Block)$$1));
        this.add(Blocks.EXPOSED_COPPER_GOLEM_STATUE, (Block $$1) -> this.createCopperGolemStatueBlock((Block)$$1));
        this.add(Blocks.WEATHERED_COPPER_GOLEM_STATUE, (Block $$1) -> this.createCopperGolemStatueBlock((Block)$$1));
        this.add(Blocks.OXIDIZED_COPPER_GOLEM_STATUE, (Block $$1) -> this.createCopperGolemStatueBlock((Block)$$1));
        this.add(Blocks.WAXED_COPPER_GOLEM_STATUE, (Block $$1) -> this.createCopperGolemStatueBlock((Block)$$1));
        this.add(Blocks.WAXED_EXPOSED_COPPER_GOLEM_STATUE, (Block $$1) -> this.createCopperGolemStatueBlock((Block)$$1));
        this.add(Blocks.WAXED_WEATHERED_COPPER_GOLEM_STATUE, (Block $$1) -> this.createCopperGolemStatueBlock((Block)$$1));
        this.add(Blocks.WAXED_OXIDIZED_COPPER_GOLEM_STATUE, (Block $$1) -> this.createCopperGolemStatueBlock((Block)$$1));
        ...
        this.add(Blocks.SEA_PICKLE, (Block $$0) -> LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0f)).add((LootPoolEntryContainer.Builder)this.applyExplosionDecay(Blocks.SEA_PICKLE, LootItem.lootTableItem($$0).apply(List.of(Integer.valueOf(2), Integer.valueOf(3), Integer.valueOf(4)), $$1 -> SetItemCountFunction.setCount(ConstantValue.exactly($$1.intValue())).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties($$0).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SeaPickleBlock.PICKLES, $$1.intValue()))))))));
        ...
        this.add(Blocks.COPPER_CHEST, (Block $$1) -> this.createNameableBlockEntityTable((Block)$$1));
        this.add(Blocks.EXPOSED_COPPER_CHEST, (Block $$1) -> this.createNameableBlockEntityTable((Block)$$1));
        this.add(Blocks.WEATHERED_COPPER_CHEST, (Block $$1) -> this.createNameableBlockEntityTable((Block)$$1));
        this.add(Blocks.OXIDIZED_COPPER_CHEST, (Block $$1) -> this.createNameableBlockEntityTable((Block)$$1));
        this.add(Blocks.WAXED_COPPER_CHEST, (Block $$1) -> this.createNameableBlockEntityTable((Block)$$1));
        this.add(Blocks.WAXED_EXPOSED_COPPER_CHEST, (Block $$1) -> this.createNameableBlockEntityTable((Block)$$1));
        this.add(Blocks.WAXED_WEATHERED_COPPER_CHEST, (Block $$1) -> this.createNameableBlockEntityTable((Block)$$1));
        this.add(Blocks.WAXED_OXIDIZED_COPPER_CHEST, (Block $$1) -> this.createNameableBlockEntityTable((Block)$$1));
        ...
        Blocks.COPPER_LANTERN.forEach($$0 -> this.add((Block)$$0, this::createSingleItemTable));
        ...
        this.add(Blocks.PLAYER_HEAD, (Block $$0) -> LootTable.lootTable().withPool(this.applyExplosionCondition((ItemLike)$$0, LootPool.lootPool().setRolls(ConstantValue.exactly(1.0f)).add((LootPoolEntryContainer.Builder<?>)((Object)LootItem.lootTableItem($$0).apply(CopyComponentsFunction.copyComponentsFromBlockEntity(LootContextParams.BLOCK_ENTITY).include(DataComponents.PROFILE).include(DataComponents.NOTE_BLOCK_SOUND).include(DataComponents.CUSTOM_NAME)))))));
        ...
        this.add(Blocks.OAK_LEAVES, (Block $$0) -> this.createOakLeavesDrops((Block)$$0, Blocks.OAK_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
        this.add(Blocks.SPRUCE_LEAVES, (Block $$0) -> this.createLeavesDrops((Block)$$0, Blocks.SPRUCE_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
        this.add(Blocks.BIRCH_LEAVES, (Block $$0) -> this.createLeavesDrops((Block)$$0, Blocks.BIRCH_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
        this.add(Blocks.JUNGLE_LEAVES, (Block $$0) -> this.createLeavesDrops((Block)$$0, Blocks.JUNGLE_SAPLING, JUNGLE_LEAVES_SAPLING_CHANGES));
        this.add(Blocks.ACACIA_LEAVES, (Block $$0) -> this.createLeavesDrops((Block)$$0, Blocks.ACACIA_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
        this.add(Blocks.DARK_OAK_LEAVES, (Block $$0) -> this.createOakLeavesDrops((Block)$$0, Blocks.DARK_OAK_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
        this.add(Blocks.PALE_OAK_LEAVES, (Block $$0) -> this.createLeavesDrops((Block)$$0, Blocks.PALE_OAK_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
        this.add(Blocks.CHERRY_LEAVES, (Block $$0) -> this.createLeavesDrops((Block)$$0, Blocks.CHERRY_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
        this.add(Blocks.AZALEA_LEAVES, (Block $$0) -> this.createLeavesDrops((Block)$$0, Blocks.AZALEA, NORMAL_LEAVES_SAPLING_CHANCES));
        this.add(Blocks.FLOWERING_AZALEA_LEAVES, (Block $$0) -> this.createLeavesDrops((Block)$$0, Blocks.FLOWERING_AZALEA, NORMAL_LEAVES_SAPLING_CHANCES));
        ...
        this.add(Blocks.SWEET_BERRY_BUSH, arg_0 -> this.lambda$generate$223((HolderLookup.RegistryLookup)$$02, arg_0));
        ...
        this.add(Blocks.NETHER_GOLD_ORE, arg_0 -> this.lambda$generate$239((HolderLookup.RegistryLookup)$$02, arg_0));
        ...
        this.add(Blocks.GLOWSTONE, arg_0 -> this.lambda$generate$264((HolderLookup.RegistryLookup)$$02, arg_0));
        this.add(Blocks.MELON, arg_0 -> this.lambda$generate$265((HolderLookup.RegistryLookup)$$02, arg_0));
        ...
        this.add(Blocks.SEA_LANTERN, arg_0 -> this.lambda$generate$268((HolderLookup.RegistryLookup)$$02, arg_0));
        this.add(Blocks.CREAKING_HEART, arg_0 -> this.lambda$generate$269((HolderLookup.RegistryLookup)$$02, arg_0));
        this.add(Blocks.NETHER_WART, arg_0 -> this.lambda$generate$270((HolderLookup.RegistryLookup)$$02, arg_0));
        ...
        this.add(Blocks.GRAVEL, arg_0 -> this.lambda$generate$274((HolderLookup.RegistryLookup)$$02, arg_0));
        ...
        this.add(Blocks.GILDED_BLACKSTONE, arg_0 -> this.lambda$generate$276((HolderLookup.RegistryLookup)$$02, arg_0));
        ...
        this.add(Blocks.AMETHYST_CLUSTER, arg_0 -> this.lambda$generate$278((HolderLookup.RegistryLookup)$$02, (HolderLookup.RegistryLookup)$$12, arg_0));
    ...
    private LootTable.Builder createDecoratedPotTable(Block $$0) {
        return LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0f)).add(((LootPoolSingletonContainer.Builder)DynamicLoot.dynamicEntry(DecoratedPotBlock.SHERDS_DYNAMIC_DROP_ID).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties($$0).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(DecoratedPotBlock.CRACKED, true)))).otherwise((LootPoolEntryContainer.Builder<?>)((Object)LootItem.lootTableItem($$0).apply(CopyComponentsFunction.copyComponentsFromBlockEntity(LootContextParams.BLOCK_ENTITY).include(DataComponents.POT_DECORATIONS))))));
    }
    ...
    private /* synthetic */ LootTable.Builder lambda$generate$274(HolderLookup.RegistryLookup $$0, Block $$1) {
        return this.createSilkTouchDispatchTable($$1, this.applyExplosionCondition($$1, ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.FLINT).when(BonusLevelTableCondition.bonusLevelFlatChance($$0.getOrThrow(Enchantments.FORTUNE), 0.1f, 0.14285715f, 0.25f, 1.0f))).otherwise(LootItem.lootTableItem($$1))));
    }

    private /* synthetic */ LootTable.Builder lambda$generate$270(HolderLookup.RegistryLookup $$0, Block $$1) {
    ...
    private /* synthetic */ LootTable.Builder lambda$generate$269(HolderLookup.RegistryLookup $$0, Block $$1) {
    ...
    private /* synthetic */ LootTable.Builder lambda$generate$268(HolderLookup.RegistryLookup $$0, Block $$1) {
    ...
    private /* synthetic */ LootTable.Builder lambda$generate$265(HolderLookup.RegistryLookup $$0, Block $$1) {
    ...
    private /* synthetic */ LootTable.Builder lambda$generate$264(HolderLookup.RegistryLookup $$0, Block $$1) {
    ...
    private /* synthetic */ LootTable.Builder lambda$generate$239(HolderLookup.RegistryLookup $$0, Block $$1) {
    ...
    private /* synthetic */ LootTable.Builder lambda$generate$223(HolderLookup.RegistryLookup $$0, Block $$1) {
