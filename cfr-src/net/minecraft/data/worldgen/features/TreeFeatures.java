...
public class TreeFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> $$0) {
        ...
        FeatureUtils.register($$0, CHERRY_BEES_005, Feature.TREE, TreeFeatures.cherry().decorators(List.of($$6)).build());
        ...
        FeatureUtils.register($$0, SUPER_BIRCH_BEES_0002, Feature.TREE, TreeFeatures.createSuperBirch().decorators((List<TreeDecorator>)ImmutableList.of((Object)$$3)).build());
        FeatureUtils.register($$0, SUPER_BIRCH_BEES, Feature.TREE, TreeFeatures.createSuperBirch().decorators((List<TreeDecorator>)ImmutableList.of((Object)$$7)).build());
        ...
        FeatureUtils.register($$0, OAK_BEES_0002_LEAF_LITTER, Feature.TREE, TreeFeatures.createOak().decorators(List.of($$3, $$8, $$9)).build());
        FeatureUtils.register($$0, OAK_BEES_002, Feature.TREE, TreeFeatures.createOak().decorators(List.of($$5)).build());
        FeatureUtils.register($$0, OAK_BEES_005, Feature.TREE, TreeFeatures.createOak().decorators(List.of($$6)).build());
        FeatureUtils.register($$0, BIRCH_BEES_0002, Feature.TREE, TreeFeatures.createBirch().decorators(List.of($$3)).build());
        FeatureUtils.register($$0, BIRCH_BEES_0002_LEAF_LITTER, Feature.TREE, TreeFeatures.createBirch().decorators(List.of($$3, $$8, $$9)).build());
        FeatureUtils.register($$0, BIRCH_BEES_002, Feature.TREE, TreeFeatures.createBirch().decorators(List.of($$5)).build());
        FeatureUtils.register($$0, BIRCH_BEES_005, Feature.TREE, TreeFeatures.createBirch().decorators(List.of($$6)).build());
        FeatureUtils.register($$0, FANCY_OAK_BEES_0002_LEAF_LITTER, Feature.TREE, TreeFeatures.createFancyOak().decorators(List.of($$3, $$8, $$9)).build());
        FeatureUtils.register($$0, FANCY_OAK_BEES_002, Feature.TREE, TreeFeatures.createFancyOak().decorators(List.of($$5)).build());
        FeatureUtils.register($$0, FANCY_OAK_BEES_005, Feature.TREE, TreeFeatures.createFancyOak().decorators(List.of($$6)).build());
        FeatureUtils.register($$0, FANCY_OAK_BEES, Feature.TREE, TreeFeatures.createFancyOak().decorators(List.of($$7)).build());
        FeatureUtils.register($$0, OAK_LEAF_LITTER, Feature.TREE, TreeFeatures.createOak().decorators((List<TreeDecorator>)ImmutableList.of((Object)$$8, (Object)$$9)).build());
        FeatureUtils.register($$0, DARK_OAK_LEAF_LITTER, Feature.TREE, TreeFeatures.createDarkOak().ignoreVines().decorators((List<TreeDecorator>)ImmutableList.of((Object)$$8, (Object)$$9)).build());
        FeatureUtils.register($$0, BIRCH_LEAF_LITTER, Feature.TREE, TreeFeatures.createBirch().decorators((List<TreeDecorator>)ImmutableList.of((Object)$$8, (Object)$$9)).build());
        FeatureUtils.register($$0, FANCY_OAK_LEAF_LITTER, Feature.TREE, TreeFeatures.createFancyOak().decorators(List.of($$8, $$9)).build());
