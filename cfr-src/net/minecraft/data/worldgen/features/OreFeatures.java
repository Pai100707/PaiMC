...
public class OreFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> $$0) {
        ...
        FeatureUtils.register($$0, ORE_REDSTONE, Feature.ORE, new OreConfiguration(List.of(OreConfiguration.target($$2, Blocks.REDSTONE_ORE.defaultBlockState()), OreConfiguration.target($$3, Blocks.DEEPSLATE_REDSTONE_ORE.defaultBlockState())), 8));
        ...
        FeatureUtils.register($$0, ORE_INFESTED, Feature.ORE, new OreConfiguration(List.of(OreConfiguration.target($$2, Blocks.INFESTED_STONE.defaultBlockState()), OreConfiguration.target($$3, Blocks.INFESTED_DEEPSLATE.defaultBlockState())), 9));
        FeatureUtils.register($$0, ORE_EMERALD, Feature.ORE, new OreConfiguration(List.of(OreConfiguration.target($$2, Blocks.EMERALD_ORE.defaultBlockState()), OreConfiguration.target($$3, Blocks.DEEPSLATE_EMERALD_ORE.defaultBlockState())), 3));
