...
public interface StructureSets {
    public static void bootstrap(BootstrapContext<StructureSet> $$0) {
        ...
        Holder.Reference<StructureSet> $$3 = $$0.register(BuiltinStructureSets.VILLAGES, new StructureSet(List.of(StructureSet.entry($$1.getOrThrow(BuiltinStructures.VILLAGE_PLAINS)), StructureSet.entry($$1.getOrThrow(BuiltinStructures.VILLAGE_DESERT)), StructureSet.entry($$1.getOrThrow(BuiltinStructures.VILLAGE_SAVANNA)), StructureSet.entry($$1.getOrThrow(BuiltinStructures.VILLAGE_SNOWY)), StructureSet.entry($$1.getOrThrow(BuiltinStructures.VILLAGE_TAIGA))), (StructurePlacement)new RandomSpreadStructurePlacement(34, 8, RandomSpreadType.LINEAR, 10387312)));
        ...
        $$0.register(BuiltinStructureSets.MINESHAFTS, new StructureSet(List.of(StructureSet.entry($$1.getOrThrow(BuiltinStructures.MINESHAFT)), StructureSet.entry($$1.getOrThrow(BuiltinStructures.MINESHAFT_MESA))), (StructurePlacement)new RandomSpreadStructurePlacement(Vec3i.ZERO, StructurePlacement.FrequencyReductionMethod.LEGACY_TYPE_3, 0.004f, 0, Optional.empty(), 1, 0, RandomSpreadType.LINEAR)));
        $$0.register(BuiltinStructureSets.RUINED_PORTALS, new StructureSet(List.of(StructureSet.entry($$1.getOrThrow(BuiltinStructures.RUINED_PORTAL_STANDARD)), StructureSet.entry($$1.getOrThrow(BuiltinStructures.RUINED_PORTAL_DESERT)), StructureSet.entry($$1.getOrThrow(BuiltinStructures.RUINED_PORTAL_JUNGLE)), StructureSet.entry($$1.getOrThrow(BuiltinStructures.RUINED_PORTAL_SWAMP)), StructureSet.entry($$1.getOrThrow(BuiltinStructures.RUINED_PORTAL_MOUNTAIN)), StructureSet.entry($$1.getOrThrow(BuiltinStructures.RUINED_PORTAL_OCEAN)), StructureSet.entry($$1.getOrThrow(BuiltinStructures.RUINED_PORTAL_NETHER))), (StructurePlacement)new RandomSpreadStructurePlacement(40, 15, RandomSpreadType.LINEAR, 34222645)));
        $$0.register(BuiltinStructureSets.SHIPWRECKS, new StructureSet(List.of(StructureSet.entry($$1.getOrThrow(BuiltinStructures.SHIPWRECK)), StructureSet.entry($$1.getOrThrow(BuiltinStructures.SHIPWRECK_BEACHED))), (StructurePlacement)new RandomSpreadStructurePlacement(24, 4, RandomSpreadType.LINEAR, 165745295)));
        $$0.register(BuiltinStructureSets.OCEAN_RUINS, new StructureSet(List.of(StructureSet.entry($$1.getOrThrow(BuiltinStructures.OCEAN_RUIN_COLD)), StructureSet.entry($$1.getOrThrow(BuiltinStructures.OCEAN_RUIN_WARM))), (StructurePlacement)new RandomSpreadStructurePlacement(20, 8, RandomSpreadType.LINEAR, 14357621)));
        $$0.register(BuiltinStructureSets.NETHER_COMPLEXES, new StructureSet(List.of(StructureSet.entry($$1.getOrThrow(BuiltinStructures.FORTRESS), 2), StructureSet.entry($$1.getOrThrow(BuiltinStructures.BASTION_REMNANT), 3)), (StructurePlacement)new RandomSpreadStructurePlacement(27, 4, RandomSpreadType.LINEAR, 30084232)));
