...
implements ArgumentType<DisplaySlot> {
    ...
    public static final DynamicCommandExceptionType ERROR_INVALID_VALUE = new DynamicCommandExceptionType($$0 -> Component.translatableEscape("argument.scoreboardDisplaySlot.invalid", $$0));
