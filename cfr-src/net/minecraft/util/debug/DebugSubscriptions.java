...
public class DebugSubscriptions<T> {
    ...
    private static DebugSubscription<?> registerSimple(String $$0) {
        return Registry.register(BuiltInRegistries.DEBUG_SUBSCRIPTION, Identifier.withDefaultNamespace($$0), new DebugSubscription(null));
    }

    private static <T> DebugSubscription<T> registerWithValue(String $$0, StreamCodec<? super RegistryFriendlyByteBuf, T> $$1) {
        return Registry.register(BuiltInRegistries.DEBUG_SUBSCRIPTION, Identifier.withDefaultNamespace($$0), new DebugSubscription<T>($$1));
    }

    private static <T> DebugSubscription<T> registerTemporaryValue(String $$0, StreamCodec<? super RegistryFriendlyByteBuf, T> $$1, int $$2) {
        return Registry.register(BuiltInRegistries.DEBUG_SUBSCRIPTION, Identifier.withDefaultNamespace($$0), new DebugSubscription<T>($$1, $$2));
    }
}
